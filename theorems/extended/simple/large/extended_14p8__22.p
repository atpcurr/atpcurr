...
cnf(myformula, negated_conjecture, plus(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))).