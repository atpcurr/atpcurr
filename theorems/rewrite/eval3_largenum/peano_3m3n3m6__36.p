%theorem: mul(neg(mul(3,3),3),6) = 36
...
cnf(myformula, negated_conjecture, mul(neg(mul(s(s(s(o))),s(s(s(o)))),s(s(s(o)))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))).