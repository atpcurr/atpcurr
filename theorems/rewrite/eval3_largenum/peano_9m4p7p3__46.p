%theorem: plus(plus(mul(9,4),7),3) = 46
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(o))))),s(s(s(s(s(s(s(o)))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))).