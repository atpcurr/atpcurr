%theorem: plus(mul(plus(4,7),7),0) = 77
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(o)))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(o)))))))),o) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).