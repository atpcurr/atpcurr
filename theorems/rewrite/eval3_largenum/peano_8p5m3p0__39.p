%theorem: plus(mul(plus(8,5),3),0) = 39
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(o)))))),s(s(s(o)))),o) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))).