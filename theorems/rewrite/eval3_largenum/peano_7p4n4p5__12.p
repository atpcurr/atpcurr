%theorem: plus(neg(plus(7,4),4),5) = 12
...
cnf(myformula, negated_conjecture, plus(neg(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(o))))),s(s(s(s(o))))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))).