%theorem: mul(neg(mul(2,2),0),6) = 24
...
cnf(myformula, negated_conjecture, mul(neg(mul(s(s(o)),s(s(o))),o),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))).