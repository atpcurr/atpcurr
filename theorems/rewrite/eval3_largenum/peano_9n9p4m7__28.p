%theorem: mul(plus(neg(9,9),4),7) = 28
...
cnf(myformula, negated_conjecture, mul(plus(neg(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(o))))),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))).