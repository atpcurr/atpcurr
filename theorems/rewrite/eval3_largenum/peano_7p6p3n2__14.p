%theorem: neg(plus(plus(7,6),3),2) = 14
...
cnf(myformula, negated_conjecture, neg(plus(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(s(o))))))),s(s(s(o)))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))).