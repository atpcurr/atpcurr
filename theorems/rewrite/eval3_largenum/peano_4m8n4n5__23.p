%theorem: neg(neg(mul(4,8),4),5) = 23
...
cnf(myformula, negated_conjecture, neg(neg(mul(s(s(s(s(o)))),s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(o))))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))).