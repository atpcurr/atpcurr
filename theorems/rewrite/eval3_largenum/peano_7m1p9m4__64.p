%theorem: mul(plus(mul(7,1),9),4) = 64
...
cnf(myformula, negated_conjecture, mul(plus(mul(s(s(s(s(s(s(s(o))))))),s(o)),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).