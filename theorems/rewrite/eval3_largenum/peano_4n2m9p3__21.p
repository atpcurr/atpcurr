%theorem: plus(mul(neg(4,2),9),3) = 21
...
cnf(myformula, negated_conjecture, plus(mul(neg(s(s(s(s(o)))),s(s(o))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))).