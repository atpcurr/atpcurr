%theorem: neg(plus(plus(1,9),6),9) = 7
...
cnf(myformula, negated_conjecture, neg(plus(plus(s(o),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(o)))))))).