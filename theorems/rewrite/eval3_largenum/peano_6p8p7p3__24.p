%theorem: plus(plus(plus(6,8),7),3) = 24
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(s(s(o)))))),s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(s(o)))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))).