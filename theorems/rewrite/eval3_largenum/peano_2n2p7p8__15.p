%theorem: plus(plus(neg(2,2),7),8) = 15
...
cnf(myformula, negated_conjecture, plus(plus(neg(s(s(o)),s(s(o))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))).