%theorem: mul(neg(neg(8,2),0),5) = 30
...
cnf(myformula, negated_conjecture, mul(neg(neg(s(s(s(s(s(s(s(s(o)))))))),s(s(o))),o),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))).