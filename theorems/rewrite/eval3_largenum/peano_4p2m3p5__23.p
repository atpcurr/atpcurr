%theorem: plus(mul(plus(4,2),3),5) = 23
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(o)))),s(s(o))),s(s(s(o)))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))).