%theorem: plus(mul(plus(8,6),3),9) = 51
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(o))))))),s(s(s(o)))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))))).