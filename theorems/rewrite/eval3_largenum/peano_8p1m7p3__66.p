%theorem: plus(mul(plus(8,1),7),3) = 66
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(s(s(s(s(o)))))))),s(o)),s(s(s(s(s(s(s(o)))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).