%theorem: neg(mul(plus(5,8),2),9) = 17
...
cnf(myformula, negated_conjecture, neg(mul(plus(s(s(s(s(s(o))))),s(s(s(s(s(s(s(s(o))))))))),s(s(o))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))).