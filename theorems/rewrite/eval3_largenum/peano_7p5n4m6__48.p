%theorem: mul(neg(plus(7,5),4),6) = 48
...
cnf(myformula, negated_conjecture, mul(neg(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(o)))))),s(s(s(s(o))))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))).