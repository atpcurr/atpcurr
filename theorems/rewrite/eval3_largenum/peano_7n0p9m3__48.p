%theorem: mul(plus(neg(7,0),9),3) = 48
...
cnf(myformula, negated_conjecture, mul(plus(neg(s(s(s(s(s(s(s(o))))))),o),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))).