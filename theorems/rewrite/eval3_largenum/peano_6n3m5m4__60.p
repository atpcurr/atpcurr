%theorem: mul(mul(neg(6,3),5),4) = 60
...
cnf(myformula, negated_conjecture, mul(mul(neg(s(s(s(s(s(s(o)))))),s(s(s(o)))),s(s(s(s(s(o)))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).