%theorem: neg(plus(plus(8,6),3),1) = 16
...
cnf(myformula, negated_conjecture, neg(plus(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(o))))))),s(s(s(o)))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))).