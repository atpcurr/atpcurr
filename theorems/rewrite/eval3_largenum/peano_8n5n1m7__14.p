%theorem: mul(neg(neg(8,5),1),7) = 14
...
cnf(myformula, negated_conjecture, mul(neg(neg(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(o)))))),s(o)),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))).