%theorem: neg(plus(plus(9,9),2),2) = 18
...
cnf(myformula, negated_conjecture, neg(plus(plus(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(o))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))).