%theorem: plus(mul(plus(4,0),8),6) = 38
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(o)))),o),s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))).