%theorem: mul(plus(plus(6,6),8),2) = 40
...
cnf(myformula, negated_conjecture, mul(plus(plus(s(s(s(s(s(s(o)))))),s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(o))))))))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))).