%theorem: plus(plus(plus(7,8),1),4) = 20
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(o))))))))),s(o)),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))).