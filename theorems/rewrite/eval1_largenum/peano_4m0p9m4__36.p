%theorem: mul(plus(mul(4,0),9),4) = 36
...
cnf(myformula, negated_conjecture, mul(plus(mul(s(s(s(s(o)))),o),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))).