%theorem: mul(plus(plus(2,8),0),4) = 40
...
cnf(myformula, negated_conjecture, mul(plus(plus(s(s(o)),s(s(s(s(s(s(s(s(o))))))))),o),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))).