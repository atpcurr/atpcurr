%theorem: plus(plus(plus(7,4),0),5) = 16
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(o))))),o),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))).