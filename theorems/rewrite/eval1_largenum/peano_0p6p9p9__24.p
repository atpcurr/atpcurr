%theorem: plus(plus(plus(0,6),9),9) = 24
...
cnf(myformula, negated_conjecture, plus(plus(plus(o,s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))).