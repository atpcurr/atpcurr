%theorem: mul(plus(plus(7,4),5),2) = 32
...
cnf(myformula, negated_conjecture, mul(plus(plus(s(s(s(s(s(s(s(o))))))),s(s(s(s(o))))),s(s(s(s(s(o)))))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))).