%theorem: mul(plus(plus(0,8),7),5) = 75
...
cnf(myformula, negated_conjecture, mul(plus(plus(o,s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).