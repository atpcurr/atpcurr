%theorem: plus(mul(plus(0,5),7),6) = 41
...
cnf(myformula, negated_conjecture, plus(mul(plus(o,s(s(s(s(s(o)))))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))).