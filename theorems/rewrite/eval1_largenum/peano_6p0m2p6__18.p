%theorem: plus(mul(plus(6,0),2),6) = 18
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(s(s(o)))))),o),s(s(o))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))).