%theorem: mul(plus(mul(3,6),2),1) = 20
...
cnf(myformula, negated_conjecture, mul(plus(mul(s(s(s(o))),s(s(s(s(s(s(o))))))),s(s(o))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))).