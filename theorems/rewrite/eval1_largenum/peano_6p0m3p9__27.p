%theorem: plus(mul(plus(6,0),3),9) = 27
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(s(s(o)))))),o),s(s(s(o)))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))).