%theorem: plus(plus(mul(5,6),2),2) = 34
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(s(s(s(o))))),s(s(s(s(s(s(o))))))),s(s(o))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))).