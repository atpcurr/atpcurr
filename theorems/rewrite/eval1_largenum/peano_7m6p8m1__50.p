%theorem: mul(plus(mul(7,6),8),1) = 50
...
cnf(myformula, negated_conjecture, mul(plus(mul(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(o))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))).