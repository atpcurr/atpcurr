%theorem: plus(plus(plus(3,6),9),8) = 26
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(o))),s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))).