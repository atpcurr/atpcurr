%theorem: plus(plus(mul(7,7),1),1) = 51
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(s(s(o)))))))),s(o)),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))))).