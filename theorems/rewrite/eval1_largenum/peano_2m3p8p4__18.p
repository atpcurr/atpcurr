%theorem: plus(plus(mul(2,3),8),4) = 18
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(o)),s(s(s(o)))),s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))).