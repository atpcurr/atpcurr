%theorem: plus(plus(mul(7,5),5),1) = 41
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(s(s(s(s(s(o))))))),s(s(s(s(s(o)))))),s(s(s(s(s(o)))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))).