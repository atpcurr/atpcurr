%theorem: mul(plus(mul(6,0),7),7) = 49
...
cnf(myformula, negated_conjecture, mul(plus(mul(s(s(s(s(s(s(o)))))),o),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))).