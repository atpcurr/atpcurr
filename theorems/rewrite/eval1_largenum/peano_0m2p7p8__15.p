%theorem: plus(plus(mul(0,2),7),8) = 15
...
cnf(myformula, negated_conjecture, plus(plus(mul(o,s(s(o))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))).