%theorem: plus(plus(plus(4,8),3),2) = 17
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(o)))),s(s(s(s(s(s(s(s(o))))))))),s(s(s(o)))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))).