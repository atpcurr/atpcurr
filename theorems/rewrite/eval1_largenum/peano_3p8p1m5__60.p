%theorem: mul(plus(plus(3,8),1),5) = 60
...
cnf(myformula, negated_conjecture, mul(plus(plus(s(s(s(o))),s(s(s(s(s(s(s(s(o))))))))),s(o)),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).