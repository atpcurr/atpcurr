%theorem: plus(plus(plus(8,2),7),1) = 18
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(o))),s(s(s(s(s(s(s(o)))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))).