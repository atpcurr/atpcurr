%theorem: plus(mul(plus(0,4),9),9) = 45
...
cnf(myformula, negated_conjecture, plus(mul(plus(o,s(s(s(s(o))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))).