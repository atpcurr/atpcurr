%theorem: mul(plus(plus(0,2),5),5) = 35
...
cnf(myformula, negated_conjecture, mul(plus(plus(o,s(s(o))),s(s(s(s(s(o)))))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))).