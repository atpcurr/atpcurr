%theorem: plus(mul(plus(2,0),9),1) = 19
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(o)),o),s(s(s(s(s(s(s(s(s(o)))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))).