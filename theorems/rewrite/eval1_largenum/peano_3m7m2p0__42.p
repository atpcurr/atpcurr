%theorem: plus(mul(mul(3,7),2),0) = 42
...
cnf(myformula, negated_conjecture, plus(mul(mul(s(s(s(o))),s(s(s(s(s(s(s(o)))))))),s(s(o))),o) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))).