%theorem: plus(plus(mul(8,8),5),9) = 78
...
cnf(myformula, negated_conjecture, plus(plus(mul(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(o)))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).