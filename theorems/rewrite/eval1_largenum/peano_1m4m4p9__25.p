%theorem: plus(mul(mul(1,4),4),9) = 25
...
cnf(myformula, negated_conjecture, plus(mul(mul(s(o),s(s(s(s(o))))),s(s(s(s(o))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))).