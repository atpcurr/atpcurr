%theorem: mul(mul(plus(7,0),8),1) = 56
...
cnf(myformula, negated_conjecture, mul(mul(plus(s(s(s(s(s(s(s(o))))))),o),s(s(s(s(s(s(s(s(o))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))))).