%--------------------------------------------------------------------------
% File     : LCL124-1 : TPTP v7.3.0. Bugfixed v2.3.0.
...
% Rating   : 0.50 v6.2.0, 0.67 v6.1.0, 0.86 v6.0.0, 0.89 v5.5.0, 0.94 v5.4.0, 1.00 v4.1.0, 0.93 v4.0.1, 0.86 v4.0.0, 0.71 v3.4.0, 0.60 v3.3.0, 0.33 v3.1.0, 0.50 v2.7.0, 0.75 v2.6.0, 0.57 v2.4.0, 0.75 v2.3.0
