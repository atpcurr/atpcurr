fof(c_0_19,conjecture,![A]:![B]:![C]:![D]:(c_Type_Otyping(A,B,hAPP(hAPP(c_Type_Otype_OFun,c_Type_Osko__Type__Xtyping__elims__2__1(C,A,B,D)),C))|~c_Type_Otyping(A,hAPP(hAPP(c_Lambda_OdB_OApp,B),D),C))).
