fof(c_0_58,conjecture,![A]:![B]:![C]:![D]:(theorem(or(A,or(not(or(not(B),C)),D)))|~theorem(or(A,B))|~theorem(or(not(C),D)))).
...
cnf(c_0_16,axiom,axiom(implies(implies(A,B),implies(or(C,A),or(C,B))))).
cnf(c_0_26,axiom,axiom(implies(or(A,B),or(B,A)))).
cnf(c_0_28,axiom,axiom(implies(or(A,A),A))).
