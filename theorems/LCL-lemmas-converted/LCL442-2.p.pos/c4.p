fof(c_0_18,conjecture,![A]:![B]:![C]:![D]:(c_in(c_PropLog_Opl_Oop_A_N_62(A,B,C),c_PropLog_Othms(D,C),tc_PropLog_Opl(C))|~c_in(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,C),c_PropLog_Othms(D,C),tc_PropLog_Opl(C)))).
