fof(c_0_78,conjecture,![A]:![B]:![C]:![D]:(c_in(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,B),C,B),c_PropLog_Othms(D,B),tc_PropLog_Opl(B))|~c_in(A,c_PropLog_Othms(D,B),tc_PropLog_Opl(B)))).
