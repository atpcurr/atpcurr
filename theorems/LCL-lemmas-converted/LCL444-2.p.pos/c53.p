fof(c_0_44,conjecture,![A]:![B]:![C]:![D]:![E]:c_in(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,B,C),B,C),c_PropLog_Othms(c_insert(D,c_insert(c_PropLog_Opl_Oop_A_N_62(D,A,C),E,tc_PropLog_Opl(C)),tc_PropLog_Opl(C)),C),tc_PropLog_Opl(C))).
