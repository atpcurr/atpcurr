fof(c_0_49,conjecture,![A]:![B]:![C]:c_in(A,c_PropLog_Othms(c_insert(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,B),A,B),C,tc_PropLog_Opl(B)),B),tc_PropLog_Opl(B))).
