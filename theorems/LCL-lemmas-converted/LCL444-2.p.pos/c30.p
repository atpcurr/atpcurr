fof(c_0_71,conjecture,![A]:![B]:![C]:![D]:c_in(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,B),C,B),c_PropLog_Othms(c_insert(A,D,tc_PropLog_Opl(B)),B),tc_PropLog_Opl(B))).
