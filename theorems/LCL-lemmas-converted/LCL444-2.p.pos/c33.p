fof(c_0_29,conjecture,![A]:![B]:![C]:![D]:![E]:(c_in(A,c_PropLog_Othms(c_insert(B,c_insert(c_PropLog_Opl_Oop_A_N_62(C,A,D),E,tc_PropLog_Opl(D)),tc_PropLog_Opl(D)),D),tc_PropLog_Opl(D))|~c_in(C,c_PropLog_Othms(c_insert(B,c_insert(c_PropLog_Opl_Oop_A_N_62(C,A,D),E,tc_PropLog_Opl(D)),tc_PropLog_Opl(D)),D),tc_PropLog_Opl(D)))).
