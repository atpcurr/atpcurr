fof(c_0_53,conjecture,![A]:![B]:![C]:(c_in(A,c_PropLog_Othms(B,C),tc_PropLog_Opl(C))|~c_in(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,C),A,C),c_PropLog_Othms(B,C),tc_PropLog_Opl(C)))).
