fof(c_0_25,conjecture,![A]:![B]:![C]:![D]:(c_in(c_PropLog_Opl_Oop_A_N_62(A,B,C),c_PropLog_Othms(D,C),tc_PropLog_Opl(C))|~c_in(B,c_PropLog_Othms(c_insert(A,D,tc_PropLog_Opl(C)),C),tc_PropLog_Opl(C)))).
