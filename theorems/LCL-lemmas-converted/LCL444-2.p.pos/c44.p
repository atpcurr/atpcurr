fof(c_0_34,conjecture,![A]:![B]:![C]:![D]:c_in(A,c_PropLog_Othms(c_insert(B,c_insert(c_PropLog_Opl_Oop_A_N_62(B,c_PropLog_Opl_Oop_A_N_62(B,A,C),C),D,tc_PropLog_Opl(C)),tc_PropLog_Opl(C)),C),tc_PropLog_Opl(C))).
