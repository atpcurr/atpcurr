fof(c_0_81,conjecture,![A]:![B]:![C]:![D]:![E]:c_in(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,c_PropLog_Opl_Ofalse,B),C,B),c_PropLog_Othms(c_insert(D,c_insert(c_PropLog_Opl_Oop_A_N_62(D,A,B),E,tc_PropLog_Opl(B)),tc_PropLog_Opl(B)),B),tc_PropLog_Opl(B))).
