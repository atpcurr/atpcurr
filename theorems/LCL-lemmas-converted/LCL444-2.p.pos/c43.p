fof(c_0_31,conjecture,![A]:![B]:![C]:![D]:(c_in(A,c_PropLog_Othms(c_insert(B,C,tc_PropLog_Opl(D)),D),tc_PropLog_Opl(D))|~c_in(c_PropLog_Opl_Oop_A_N_62(B,A,D),c_PropLog_Othms(c_insert(B,C,tc_PropLog_Opl(D)),D),tc_PropLog_Opl(D)))).
