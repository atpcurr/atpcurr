fof(c_0_56,conjecture,![A]:![B]:![C]:![D]:c_in(A,c_PropLog_Othms(c_insert(c_PropLog_Opl_Oop_A_N_62(c_PropLog_Opl_Oop_A_N_62(A,B,C),A,C),D,tc_PropLog_Opl(C)),C),tc_PropLog_Opl(C))).
