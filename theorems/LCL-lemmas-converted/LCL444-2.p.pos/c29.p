fof(c_0_67,conjecture,![A]:![B]:![C]:![D]:c_in(A,c_PropLog_Othms(c_insert(c_PropLog_Opl_Oop_A_N_62(B,c_PropLog_Opl_Ofalse,C),c_insert(B,D,tc_PropLog_Opl(C)),tc_PropLog_Opl(C)),C),tc_PropLog_Opl(C))).
