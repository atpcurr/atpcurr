fof(c_0_19,conjecture,![A]:![B]:![C]:![D]:(c_in(A,c_PropLog_Othms(B,C),tc_PropLog_Opl(C))|~c_in(c_PropLog_Opl_Oop_A_N_62(D,A,C),c_PropLog_Othms(B,C),tc_PropLog_Opl(C))|~c_in(D,c_PropLog_Othms(B,C),tc_PropLog_Opl(C)))).
