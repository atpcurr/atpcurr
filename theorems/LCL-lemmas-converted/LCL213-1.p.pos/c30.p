fof(c_0_47,conjecture,![A]:![B]:![C]:![D]:(theorem(or(not(or(not(A),B)),C))|~theorem(or(not(or(not(or(D,A)),or(D,B))),C)))).
...
cnf(c_0_14,axiom,axiom(or(not(or(A,A)),A))).
cnf(c_0_24,axiom,axiom(or(not(or(A,B)),or(B,A)))).
cnf(c_0_37,axiom,axiom(or(not(or(not(A),B)),or(not(or(C,A)),or(C,B))))).
