fof(c_0_35,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(equivalent(A,equivalent(equivalent(B,equivalent(C,D)),E)))|~is_a_theorem(equivalent(equivalent(B,equivalent(equivalent(D,C),A)),E)))).
