fof(c_0_33,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),C),D))|~is_a_theorem(equivalent(equivalent(equivalent(E,B),equivalent(equivalent(A,E),C)),D)))).
