fof(c_0_40,conjecture,![A]:![B]:![C]:![D]:(theorem(or(not(or(A,B)),or(C,not(or(not(B),D)))))|~theorem(or(not(or(A,D)),or(C,not(or(not(B),D))))))).
...
cnf(c_0_21,axiom,axiom(or(not(or(A,B)),or(B,A)))).
cnf(c_0_24,axiom,(theorem(A)|~axiom(A))).
