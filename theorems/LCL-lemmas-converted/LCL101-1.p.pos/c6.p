fof(c_0_11,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:is_a_theorem(equivalent(equivalent(equivalent(equivalent(A,B),equivalent(A,C)),equivalent(B,C)),equivalent(equivalent(equivalent(D,E),equivalent(D,F)),equivalent(E,F))))).
...
cnf(c_0_5,axiom,is_a_theorem(equivalent(equivalent(equivalent(equivalent(equivalent(A,B),equivalent(A,C)),equivalent(B,C)),D),D))).
