fof(c_0_27,conjecture,![A]:![B]:![C]:(theorem(or(A,B))|~theorem(or(A,C))|~theorem(or(not(C),B)))).
...
cnf(c_0_31,axiom,axiom(implies(A,or(B,A)))).
cnf(c_0_33,axiom,and(A,B)=not(or(not(A),not(B)))).
