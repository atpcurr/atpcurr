fof(c_0_12,conjecture,c_Type_Otyping(c_Type_Oshift(v_e____,v_i____,v_T____,tc_Type_Otype),c_Lambda_OdB_OVar(v_n____),hAPP(hAPP(c_Type_Otype_OFun,v_T_H_H____),c_List_Ofoldl(c_COMBC(c_Type_Otype_OFun,tc_Type_Otype,tc_Type_Otype,tc_Type_Otype),v_T_H____,c_List_Orev(v_Ts____,tc_Type_Otype),tc_Type_Otype,tc_Type_Otype)))).
