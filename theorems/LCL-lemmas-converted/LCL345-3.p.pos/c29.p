fof(c_0_55,conjecture,![A]:![B]:![C]:(theorem(or(A,not(or(not(B),not(C)))))|~theorem(or(A,B))|~theorem(C))).
...
cnf(c_0_34,axiom,equivalent(A,B)=and(implies(A,B),implies(B,A))).
cnf(c_0_35,axiom,and(A,B)=not(or(not(A),not(B)))).
