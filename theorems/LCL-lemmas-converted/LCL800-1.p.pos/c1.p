fof(c_0_12,conjecture,c_InductTermi_OIT(c_Lambda_Osubst(c_Lambda_OdB_OApp(c_Lambda_Olift(v_u____,c_HOL_Ozero__class_Ozero(tc_nat)),c_Lambda_OdB_OVar(c_HOL_Ozero__class_Ozero(tc_nat))),c_Lambda_Osubst(v_a____,v_u____,v_i____),c_HOL_Ozero__class_Ozero(tc_nat)))).
