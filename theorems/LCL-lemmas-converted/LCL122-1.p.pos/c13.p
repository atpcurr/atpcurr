fof(c_0_33,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),equivalent(equivalent(A,C),equivalent(B,C))),D))|~is_a_theorem(equivalent(E,D))|~is_a_theorem(E))).
