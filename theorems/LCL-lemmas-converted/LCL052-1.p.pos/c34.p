fof(c_0_55,conjecture,![A]:![B]:![C]:![D]:(is_a_theorem(implies(not(implies(implies(A,B),implies(C,B))),D))|~is_a_theorem(implies(not(implies(implies(A,B),implies(C,B))),implies(C,A))))).
