fof(c_0_59,conjecture,![A]:![B]:![C]:![D]:(is_a_theorem(implies(not(implies(implies(A,B),implies(not(C),B))),D))|~is_a_theorem(implies(not(implies(implies(A,B),implies(not(C),B))),C)))).
