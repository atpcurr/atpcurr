fof(c_0_13,conjecture,![A]:![B]:(c_Lambda_Olift(c_Lambda_OdB_OVar(A),B)=c_Lambda_OdB_OVar(c_HOL_Oplus__class_Oplus(A,c_HOL_Oone__class_Oone(tc_nat),tc_nat))|c_HOL_Oord__class_Oless(A,B,tc_nat))).
