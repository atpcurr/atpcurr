fof(c_0_17,conjecture,![A]:![B]:![C]:(c_InductTermi_OIT(c_Lambda_Osubst(c_Lambda_OdB_OAbs(A),c_Lambda_OdB_OVar(B),C))|~c_InductTermi_OIT(c_Lambda_Osubst(A,c_Lambda_OdB_OVar(c_HOL_Oplus__class_Oplus(B,c_HOL_Oone__class_Oone(tc_nat),tc_nat)),c_HOL_Oplus__class_Oplus(C,c_HOL_Oone__class_Oone(tc_nat),tc_nat))))).
