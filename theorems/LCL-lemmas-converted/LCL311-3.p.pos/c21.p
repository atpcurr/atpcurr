fof(c_0_47,conjecture,![A]:![B]:(theorem(not(or(not(A),not(B))))|~theorem(A)|~theorem(B))).
...
cnf(c_0_15,axiom,axiom(implies(or(A,B),or(B,A)))).
cnf(c_0_27,axiom,equivalent(A,B)=and(implies(A,B),implies(B,A))).
cnf(c_0_28,axiom,and(A,B)=not(or(not(A),not(B)))).
cnf(c_0_31,axiom,axiom(implies(or(A,A),A))).
cnf(c_0_32,axiom,axiom(implies(A,or(B,A)))).
