fof(c_0_26,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(A,equivalent(B,C)),D),equivalent(equivalent(E,C),equivalent(equivalent(A,equivalent(B,E)),D))))).
