fof(c_0_23,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(equivalent(A,equivalent(B,C)),equivalent(A,equivalent(B,D))),E),equivalent(equivalent(C,D),E)))).
