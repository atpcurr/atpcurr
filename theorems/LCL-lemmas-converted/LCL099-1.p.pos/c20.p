fof(c_0_20,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(equivalent(A,B),C),D),equivalent(equivalent(equivalent(equivalent(E,A),equivalent(E,B)),C),D)))).
