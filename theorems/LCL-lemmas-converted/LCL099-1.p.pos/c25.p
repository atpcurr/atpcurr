fof(c_0_30,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(A,B),C),equivalent(equivalent(D,B),equivalent(equivalent(E,equivalent(A,D)),equivalent(E,C)))))).
