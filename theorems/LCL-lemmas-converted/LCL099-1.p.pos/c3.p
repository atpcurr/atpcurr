fof(c_0_7,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(equivalent(equivalent(equivalent(A,B),equivalent(A,C)),D),equivalent(equivalent(B,C),D)),E),E))).
