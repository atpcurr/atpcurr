fof(c_0_61,conjecture,![A]:![B]:![C]:(theorem(or(A,not(or(not(B),not(C)))))|~theorem(or(A,B))|~theorem(C))).
...
cnf(c_0_22,axiom,axiom(implies(or(A,A),A))).
cnf(c_0_23,axiom,axiom(implies(A,or(B,A)))).
cnf(c_0_37,axiom,equivalent(A,B)=and(implies(A,B),implies(B,A))).
cnf(c_0_38,axiom,and(A,B)=not(or(not(A),not(B)))).
