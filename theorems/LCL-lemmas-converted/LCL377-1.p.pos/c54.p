fof(c_0_76,conjecture,![A]:![B]:![C]:![D]:(is_a_theorem(implies(A,implies(implies(B,C),implies(D,C))))|~is_a_theorem(implies(not(implies(implies(B,C),implies(D,C))),implies(D,B))))).
