fof(c_0_70,conjecture,![A]:![B]:![C]:![D]:(theorem(or(A,or(not(or(not(B),C)),D)))|~theorem(or(A,B))|~theorem(or(not(C),D)))).
...
cnf(c_0_15,axiom,axiom(implies(or(A,or(B,C)),or(B,or(A,C))))).
cnf(c_0_16,axiom,axiom(implies(A,or(B,A)))).
cnf(c_0_20,axiom,axiom(implies(or(A,B),or(B,A)))).
cnf(c_0_23,axiom,axiom(implies(or(A,A),A))).
cnf(c_0_58,axiom,and(A,B)=not(or(not(A),not(B)))).
