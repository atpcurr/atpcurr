fof(c_0_49,conjecture,![A]:![B]:![C]:![D]:(theorem(or(or(not(or(not(A),B)),C),D))|~theorem(or(not(B),C))|~theorem(or(D,A)))).
...
cnf(c_0_20,axiom,axiom(implies(implies(A,B),implies(or(C,A),or(C,B))))).
cnf(c_0_32,axiom,axiom(implies(or(A,B),or(B,A)))).
