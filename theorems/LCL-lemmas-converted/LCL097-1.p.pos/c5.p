fof(c_0_10,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(A)|~is_a_theorem(equivalent(equivalent(equivalent(equivalent(equivalent(B,C),equivalent(B,D)),E),equivalent(equivalent(C,D),E)),A)))).
