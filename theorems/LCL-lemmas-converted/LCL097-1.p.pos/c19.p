fof(c_0_23,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(equivalent(equivalent(A,equivalent(equivalent(B,C),D)),E))|~is_a_theorem(equivalent(equivalent(A,equivalent(equivalent(F,C),equivalent(equivalent(B,F),D))),E)))).
