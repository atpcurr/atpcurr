fof(c_0_27,conjecture,![A]:![B]:![C]:![D]:![E]:is_a_theorem(equivalent(equivalent(equivalent(equivalent(A,B),C),equivalent(equivalent(D,B),E)),equivalent(C,equivalent(equivalent(D,A),E))))).
