fof(c_0_78,conjecture,![A]:![B]:![C]:![D]:(theorem(or(or(not(or(not(A),B)),C),D))|~theorem(or(not(B),C))|~theorem(or(D,A)))).
...
cnf(c_0_21,axiom,axiom(implies(or(A,A),A))).
cnf(c_0_23,axiom,axiom(implies(A,or(B,A)))).
cnf(c_0_48,axiom,equivalent(A,B)=and(implies(A,B),implies(B,A))).
cnf(c_0_49,axiom,and(A,B)=not(or(not(A),not(B)))).
