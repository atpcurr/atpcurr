fof(c_0_12,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),C),equivalent(equivalent(D,B),C)))|~is_a_theorem(E)|~is_a_theorem(equivalent(E,equivalent(A,D))))).
