fof(c_0_13,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(A)|~is_a_theorem(equivalent(equivalent(B,C),equivalent(equivalent(equivalent(D,E),equivalent(F,E)),C)))|~is_a_theorem(equivalent(equivalent(B,equivalent(D,F)),A)))).
