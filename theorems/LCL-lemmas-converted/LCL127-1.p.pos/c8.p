fof(c_0_14,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),C),equivalent(equivalent(equivalent(equivalent(D,E),equivalent(F,E)),B),C)))|~is_a_theorem(equivalent(A,equivalent(D,F))))).
