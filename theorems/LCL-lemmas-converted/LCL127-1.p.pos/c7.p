fof(c_0_10,conjecture,![A]:![B]:![C]:![D]:![E]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),equivalent(C,B)),D))|~is_a_theorem(equivalent(E,D))|~is_a_theorem(equivalent(E,equivalent(A,C))))).
