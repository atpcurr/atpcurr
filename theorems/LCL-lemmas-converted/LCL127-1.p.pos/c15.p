fof(c_0_19,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(equivalent(equivalent(equivalent(equivalent(equivalent(A,B),equivalent(C,B)),equivalent(D,D)),E),equivalent(F,E)))|~is_a_theorem(equivalent(F,equivalent(A,C))))).
