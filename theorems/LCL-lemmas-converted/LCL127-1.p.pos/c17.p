fof(c_0_20,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(equivalent(A,B))|~is_a_theorem(equivalent(equivalent(equivalent(equivalent(C,D),equivalent(E,D)),equivalent(F,F)),B))|~is_a_theorem(equivalent(A,equivalent(C,E))))).
