fof(c_0_17,conjecture,![A]:![B]:![C]:![D]:![E]:![F]:(is_a_theorem(equivalent(equivalent(equivalent(A,B),C),equivalent(D,C)))|~is_a_theorem(equivalent(E,equivalent(D,equivalent(F,B))))|~is_a_theorem(equivalent(E,equivalent(A,F))))).
