fof(c_0_42,conjecture,![A]:![B]:![C]:(is_a_theorem(implies(implies(A,B),implies(C,B)))|~is_a_theorem(implies(not(implies(C,A)),implies(C,A))))).
...
cnf(c_0_13,axiom,is_a_theorem(implies(implies(not(A),A),A))).
