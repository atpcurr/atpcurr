%theorem: plus(mul(mul(7,8),2),8) = mul(mul(plus(6,4),6),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1))).