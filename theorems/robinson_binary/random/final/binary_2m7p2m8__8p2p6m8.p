%theorem: mul(plus(mul(2,7),2),8) = mul(plus(plus(8,2),6),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).