%theorem: plus(mul(plus(8,2),5),2) = mul(plus(plus(4,1),8),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).