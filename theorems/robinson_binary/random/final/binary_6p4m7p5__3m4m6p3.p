%theorem: plus(mul(plus(6,4),7),5) = plus(mul(mul(3,4),6),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = plus(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1))).