%theorem: plus(plus(plus(7,1),9),1) = plus(mul(plus(5,1),2),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),n1) = plus(mul(plus(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n0,b(n1,n1)))).