%theorem: plus(plus(mul(7,1),9),8) = plus(mul(mul(8,1),2),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,b(n0,b(n0,n1))),n1),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).