%theorem: mul(mul(mul(4,2),9),6) = mul(mul(plus(5,3),6),9)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(mul(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).