%theorem: plus(plus(plus(3,1),3),4) = plus(mul(mul(1,4),1),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n0,b(n0,n1))) = plus(mul(mul(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1)))).