%theorem: plus(plus(plus(8,2),3),1) = mul(mul(mul(1,1),7),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),n1) = mul(mul(mul(n1,n1),b(n1,b(n1,n1))),b(n0,n1))).