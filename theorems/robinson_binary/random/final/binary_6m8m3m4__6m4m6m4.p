%theorem: mul(mul(mul(6,8),3),4) = mul(mul(mul(6,4),6),4)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,n1))) = mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1)))).