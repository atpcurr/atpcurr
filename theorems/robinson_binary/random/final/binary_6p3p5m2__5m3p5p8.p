%theorem: mul(plus(plus(6,3),5),2) = plus(plus(mul(5,3),5),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).