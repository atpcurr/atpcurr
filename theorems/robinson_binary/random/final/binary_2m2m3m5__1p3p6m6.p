%theorem: mul(mul(mul(2,2),3),5) = mul(plus(plus(1,3),6),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))) = mul(plus(plus(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).