%theorem: mul(mul(plus(4,2),1),7) = mul(mul(plus(3,3),1),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),n1),b(n1,b(n1,n1))) = mul(mul(plus(b(n1,n1),b(n1,n1)),n1),b(n1,b(n1,n1)))).