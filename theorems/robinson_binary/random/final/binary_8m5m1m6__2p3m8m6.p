%theorem: mul(mul(mul(8,5),1),6) = mul(mul(plus(2,3),8),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n1,n1))) = mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).