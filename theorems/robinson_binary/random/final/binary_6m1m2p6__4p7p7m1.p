%theorem: plus(mul(mul(6,1),2),6) = mul(plus(plus(4,7),7),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),n1)).