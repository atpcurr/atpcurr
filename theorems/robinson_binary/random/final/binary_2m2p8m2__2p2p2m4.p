%theorem: mul(plus(mul(2,2),8),2) = mul(plus(plus(2,2),2),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1)))).