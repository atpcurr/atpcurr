%theorem: plus(plus(plus(2,4),9),7) = mul(plus(mul(3,6),4),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),n1)).