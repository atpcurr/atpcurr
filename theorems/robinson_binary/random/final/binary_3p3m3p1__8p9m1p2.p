%theorem: plus(mul(plus(3,3),3),1) = plus(mul(plus(8,9),1),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),n1) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,n1))).