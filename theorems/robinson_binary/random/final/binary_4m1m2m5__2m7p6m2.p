%theorem: mul(mul(mul(4,1),2),5) = mul(plus(mul(2,7),6),2)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),n1),b(n0,n1)),b(n1,b(n0,n1))) = mul(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n0,n1))).