%theorem: mul(plus(plus(5,5),3),2) = plus(plus(plus(3,8),6),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n0,n1)) = plus(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).