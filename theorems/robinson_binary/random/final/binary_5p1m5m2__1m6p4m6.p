%theorem: mul(mul(plus(5,1),5),2) = mul(plus(mul(1,6),4),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,n1)) = mul(plus(mul(n1,b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).