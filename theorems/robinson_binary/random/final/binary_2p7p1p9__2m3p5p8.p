%theorem: plus(plus(plus(2,7),1),9) = plus(plus(mul(2,3),5),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n1,b(n1,n1))),n1),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).