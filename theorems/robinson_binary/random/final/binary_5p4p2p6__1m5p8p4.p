%theorem: plus(plus(plus(5,4),2),6) = plus(plus(mul(1,5),8),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(n1,b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).