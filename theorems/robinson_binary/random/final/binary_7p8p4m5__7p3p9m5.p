%theorem: mul(plus(plus(7,8),4),5) = mul(plus(plus(7,3),9),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n1,b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).