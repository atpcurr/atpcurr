%theorem: plus(mul(plus(5,1),2),6) = plus(mul(plus(1,2),4),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(mul(plus(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).