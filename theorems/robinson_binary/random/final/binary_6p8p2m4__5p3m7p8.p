%theorem: mul(plus(plus(6,8),2),4) = plus(mul(plus(5,3),7),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,n1))) = plus(mul(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).