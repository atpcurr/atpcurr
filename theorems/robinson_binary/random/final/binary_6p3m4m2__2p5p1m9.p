%theorem: mul(mul(plus(6,3),4),2) = mul(plus(plus(2,5),1),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1))))).