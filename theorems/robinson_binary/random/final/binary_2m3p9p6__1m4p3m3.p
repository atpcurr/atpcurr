%theorem: plus(plus(mul(2,3),9),6) = mul(plus(mul(1,4),3),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(mul(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1))).