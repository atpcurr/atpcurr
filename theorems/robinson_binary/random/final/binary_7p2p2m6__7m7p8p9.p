%theorem: mul(plus(plus(7,2),2),6) = plus(plus(mul(7,7),8),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).