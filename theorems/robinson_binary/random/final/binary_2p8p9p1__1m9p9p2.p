%theorem: plus(plus(plus(2,8),9),1) = plus(plus(mul(1,9),9),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),n1) = plus(plus(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,n1))).