%theorem: mul(mul(plus(2,6),2),7) = mul(plus(plus(2,5),9),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n1,n1))) = mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).