%theorem: plus(plus(plus(4,7),1),5) = plus(mul(plus(2,3),2),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1))) = plus(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1)))).