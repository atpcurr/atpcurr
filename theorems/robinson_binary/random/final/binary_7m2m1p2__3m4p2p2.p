%theorem: plus(mul(mul(7,2),1),2) = plus(plus(mul(3,4),2),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),n1),b(n0,n1)) = plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1))).