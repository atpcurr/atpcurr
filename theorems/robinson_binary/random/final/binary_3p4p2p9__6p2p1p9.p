%theorem: plus(plus(plus(3,4),2),9) = plus(plus(plus(6,2),1),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),n1),b(n1,b(n0,b(n0,n1))))).