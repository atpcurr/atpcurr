%theorem: plus(mul(plus(3,3),3),1) = plus(plus(plus(3,8),1),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),n1) = plus(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n1,n1)))).