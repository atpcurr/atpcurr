%theorem: mul(plus(mul(7,2),6),4) = plus(plus(mul(8,9),5),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1))).