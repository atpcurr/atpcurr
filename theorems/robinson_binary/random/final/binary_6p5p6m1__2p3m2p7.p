%theorem: mul(plus(plus(6,5),6),1) = plus(mul(plus(2,3),2),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n1,n1))),n1) = plus(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1)))).