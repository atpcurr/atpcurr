%theorem: mul(plus(plus(9,1),5),6) = mul(mul(plus(2,4),3),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = mul(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1)))).