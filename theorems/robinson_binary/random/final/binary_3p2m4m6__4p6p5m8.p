%theorem: mul(mul(plus(3,2),4),6) = mul(plus(plus(4,6),5),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).