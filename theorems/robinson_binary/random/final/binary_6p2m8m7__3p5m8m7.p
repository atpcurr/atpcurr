%theorem: mul(mul(plus(6,2),8),7) = mul(mul(plus(3,5),8),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).