%theorem: mul(plus(mul(6,1),5),1) = plus(plus(plus(3,1),3),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),n1),b(n1,b(n0,n1))),n1) = plus(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n0,b(n0,n1)))).