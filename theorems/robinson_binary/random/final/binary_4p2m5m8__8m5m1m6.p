%theorem: mul(mul(plus(4,2),5),8) = mul(mul(mul(8,5),1),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n1,n1)))).