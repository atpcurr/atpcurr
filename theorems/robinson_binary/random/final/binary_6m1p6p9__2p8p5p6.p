%theorem: plus(plus(mul(6,1),6),9) = plus(plus(plus(2,8),5),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).