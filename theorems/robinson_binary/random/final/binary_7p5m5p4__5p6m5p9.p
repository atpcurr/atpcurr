%theorem: plus(mul(plus(7,5),5),4) = plus(mul(plus(5,6),5),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).