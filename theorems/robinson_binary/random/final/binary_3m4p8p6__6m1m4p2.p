%theorem: plus(plus(mul(3,4),8),6) = plus(mul(mul(6,1),4),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n0,n1))).