%theorem: plus(mul(plus(9,5),2),6) = mul(plus(mul(8,1),9),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))),b(n0,n1))).