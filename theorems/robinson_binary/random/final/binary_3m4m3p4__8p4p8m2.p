%theorem: plus(mul(mul(3,4),3),4) = mul(plus(plus(8,4),8),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1))).