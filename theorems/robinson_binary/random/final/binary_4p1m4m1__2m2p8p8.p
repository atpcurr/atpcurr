%theorem: mul(mul(plus(4,1),4),1) = plus(plus(mul(2,2),8),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),n1) = plus(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).