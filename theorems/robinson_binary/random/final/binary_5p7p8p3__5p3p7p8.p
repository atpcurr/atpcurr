%theorem: plus(plus(plus(5,7),8),3) = plus(plus(plus(5,3),7),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).