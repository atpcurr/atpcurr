%theorem: plus(plus(plus(8,9),1),8) = plus(mul(mul(6,1),4),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n0,n1))).