%theorem: plus(mul(mul(6,9),2),2) = mul(mul(plus(7,4),5),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,n1)) = mul(mul(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1))).