%theorem: plus(plus(mul(6,7),5),7) = plus(plus(mul(8,5),8),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).