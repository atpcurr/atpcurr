%theorem: plus(plus(mul(4,9),6),5) = plus(plus(mul(5,7),3),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = plus(plus(mul(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).