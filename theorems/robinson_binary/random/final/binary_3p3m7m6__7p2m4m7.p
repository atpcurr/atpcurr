%theorem: mul(mul(plus(3,3),7),6) = mul(mul(plus(7,2),4),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = mul(mul(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).