%theorem: mul(plus(plus(6,6),3),8) = mul(mul(plus(6,4),6),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1))).