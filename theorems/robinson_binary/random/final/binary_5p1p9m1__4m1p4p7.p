%theorem: mul(plus(plus(5,1),9),1) = plus(plus(mul(4,1),4),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,b(n0,n1)))),n1) = plus(plus(mul(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).