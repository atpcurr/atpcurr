%theorem: mul(mul(plus(3,3),8),1) = mul(plus(mul(2,1),4),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),n1) = mul(plus(mul(b(n0,n1),n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).