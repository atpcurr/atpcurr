%theorem: plus(plus(plus(6,9),2),2) = mul(plus(mul(9,2),1),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,n1)) = mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),n1),n1)).