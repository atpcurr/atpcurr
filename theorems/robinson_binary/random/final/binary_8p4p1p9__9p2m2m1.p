%theorem: plus(plus(plus(8,4),1),9) = mul(mul(plus(9,2),2),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1)),n1)).