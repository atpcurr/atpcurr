%theorem: mul(plus(plus(8,3),5),9) = mul(mul(plus(1,3),9),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).