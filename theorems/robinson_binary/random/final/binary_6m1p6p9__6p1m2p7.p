%theorem: plus(plus(mul(6,1),6),9) = plus(mul(plus(6,1),2),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n1,b(n1,n1)))).