%theorem: plus(mul(mul(8,8),1),5) = plus(mul(plus(5,8),5),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1))) = plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).