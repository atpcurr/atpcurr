%theorem: mul(plus(plus(5,5),1),1) = plus(mul(mul(1,4),1),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),n1),n1) = plus(mul(mul(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1)))).