%theorem: mul(mul(mul(3,7),5),2) = mul(mul(plus(7,7),5),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n0,n1)) = mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,n1))).