%theorem: plus(mul(mul(3,4),3),8) = plus(plus(mul(8,4),3),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).