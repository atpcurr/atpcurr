%theorem: plus(mul(mul(9,3),2),2) = mul(plus(plus(2,4),1),8)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n0,n1)) = mul(plus(plus(b(n0,n1),b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1))))).