%theorem: plus(mul(mul(3,8),1),8) = mul(plus(mul(3,1),5),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,n1),n1),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).