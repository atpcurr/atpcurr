%theorem: mul(mul(mul(6,1),2),9) = mul(mul(plus(5,1),6),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n1,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n1,n1))).