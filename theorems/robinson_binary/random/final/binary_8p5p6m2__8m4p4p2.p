%theorem: mul(plus(plus(8,5),6),2) = plus(plus(mul(8,4),4),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1))).