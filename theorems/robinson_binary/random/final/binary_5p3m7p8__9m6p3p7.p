%theorem: plus(mul(plus(5,3),7),8) = plus(plus(mul(9,6),3),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1)),b(n1,b(n1,n1)))).