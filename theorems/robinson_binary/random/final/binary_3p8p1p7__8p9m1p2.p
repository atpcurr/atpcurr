%theorem: plus(plus(plus(3,8),1),7) = plus(mul(plus(8,9),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,n1))).