%theorem: plus(mul(mul(7,1),8),8) = mul(mul(plus(8,8),1),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,n1)))).