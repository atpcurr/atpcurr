%theorem: mul(mul(mul(9,6),1),5) = mul(mul(plus(2,3),9),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),n1),b(n1,b(n0,n1))) = mul(mul(plus(b(n0,n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).