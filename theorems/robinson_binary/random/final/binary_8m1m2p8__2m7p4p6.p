%theorem: plus(mul(mul(8,1),2),8) = plus(plus(mul(2,7),4),6)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).