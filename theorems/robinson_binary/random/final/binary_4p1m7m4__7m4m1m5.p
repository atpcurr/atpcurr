%theorem: mul(mul(plus(4,1),7),4) = mul(mul(mul(7,4),1),5)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = mul(mul(mul(b(n1,b(n1,n1)),b(n0,b(n0,n1))),n1),b(n1,b(n0,n1)))).