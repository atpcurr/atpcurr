%theorem: plus(plus(plus(4,3),7),4) = plus(plus(mul(1,7),5),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(plus(mul(n1,b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).