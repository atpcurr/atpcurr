%theorem: plus(plus(plus(6,5),9),3) = plus(plus(plus(5,7),4),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).