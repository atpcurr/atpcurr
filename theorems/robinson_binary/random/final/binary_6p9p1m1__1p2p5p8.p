%theorem: mul(plus(plus(6,9),1),1) = plus(plus(plus(1,2),5),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1),n1) = plus(plus(plus(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).