%theorem: plus(plus(mul(8,1),5),5) = plus(plus(mul(1,2),7),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = plus(plus(mul(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).