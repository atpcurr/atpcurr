%theorem: mul(mul(plus(3,3),6),8) = mul(mul(mul(2,8),2),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,b(n0,n1))))).