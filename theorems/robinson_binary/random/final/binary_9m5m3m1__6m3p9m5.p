%theorem: mul(mul(mul(9,5),3),1) = mul(plus(mul(6,3),9),5)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,n1)),n1) = mul(plus(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).