%theorem: mul(plus(plus(7,7),2),4) = plus(plus(mul(9,6),4),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).