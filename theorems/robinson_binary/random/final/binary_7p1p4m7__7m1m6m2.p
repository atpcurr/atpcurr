%theorem: mul(plus(plus(7,1),4),7) = mul(mul(mul(7,1),6),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = mul(mul(mul(b(n1,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n0,n1))).