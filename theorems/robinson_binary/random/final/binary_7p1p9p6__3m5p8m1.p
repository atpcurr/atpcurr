%theorem: plus(plus(plus(7,1),9),6) = mul(plus(mul(3,5),8),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),n1)).