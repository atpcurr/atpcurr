%theorem: plus(plus(mul(3,8),6),1) = plus(mul(plus(1,2),9),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),n1) = plus(mul(plus(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).