%theorem: plus(mul(plus(4,3),1),7) = plus(plus(plus(8,2),3),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n1,n1)),n1),b(n1,b(n1,n1))) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),n1)).