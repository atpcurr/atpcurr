%theorem: plus(plus(mul(4,9),9),3) = mul(plus(mul(2,1),4),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(mul(b(n0,n1),n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).