%theorem: mul(plus(mul(4,6),8),8) = mul(mul(plus(8,8),4),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,n1)))).