%theorem: mul(plus(mul(5,3),4),1) = plus(plus(plus(7,5),2),5)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),n1) = plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1)))).