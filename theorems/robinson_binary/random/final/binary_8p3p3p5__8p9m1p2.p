%theorem: plus(plus(plus(8,3),3),5) = plus(mul(plus(8,9),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,n1))).