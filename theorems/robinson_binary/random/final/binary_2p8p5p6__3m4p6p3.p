%theorem: plus(plus(plus(2,8),5),6) = plus(plus(mul(3,4),6),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1))).