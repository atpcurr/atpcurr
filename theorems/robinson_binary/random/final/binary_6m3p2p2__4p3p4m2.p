%theorem: plus(plus(mul(6,3),2),2) = mul(plus(plus(4,3),4),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n0,n1)),b(n0,n1)) = mul(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1))).