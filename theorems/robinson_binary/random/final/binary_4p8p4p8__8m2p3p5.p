%theorem: plus(plus(plus(4,8),4),8) = plus(plus(mul(8,2),3),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1)))).