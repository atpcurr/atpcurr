%theorem: plus(mul(plus(2,2),5),3) = plus(mul(plus(3,3),3),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)) = plus(mul(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1)))).