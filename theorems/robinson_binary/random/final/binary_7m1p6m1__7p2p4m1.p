%theorem: mul(plus(mul(7,1),6),1) = mul(plus(plus(7,2),4),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),n1),b(n0,b(n1,n1))),n1) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),n1)).