%theorem: mul(mul(plus(3,3),8),1) = plus(plus(mul(4,9),9),3)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),n1) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).