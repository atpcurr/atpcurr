%theorem: plus(plus(plus(2,7),7),7) = plus(mul(plus(2,5),3),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n0,n1),b(n1,b(n0,n1))),b(n1,n1)),b(n0,n1))).