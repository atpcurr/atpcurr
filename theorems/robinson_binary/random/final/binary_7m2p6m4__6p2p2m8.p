%theorem: mul(plus(mul(7,2),6),4) = mul(plus(plus(6,2),2),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).