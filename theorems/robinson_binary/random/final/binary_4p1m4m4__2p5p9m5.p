%theorem: mul(mul(plus(4,1),4),4) = mul(plus(plus(2,5),9),5)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).