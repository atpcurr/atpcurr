%theorem: plus(mul(plus(8,4),2),6) = mul(mul(plus(2,3),2),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,n1))).