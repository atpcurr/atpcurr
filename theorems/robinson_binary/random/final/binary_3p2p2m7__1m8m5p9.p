%theorem: mul(plus(plus(3,2),2),7) = plus(mul(mul(1,8),5),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))) = plus(mul(mul(n1,b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).