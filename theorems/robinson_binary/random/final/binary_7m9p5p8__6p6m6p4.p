%theorem: plus(plus(mul(7,9),5),8) = plus(mul(plus(6,6),6),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1)))).