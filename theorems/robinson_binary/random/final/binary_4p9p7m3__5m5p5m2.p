%theorem: mul(plus(plus(4,9),7),3) = mul(plus(mul(5,5),5),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1)) = mul(plus(mul(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1))).