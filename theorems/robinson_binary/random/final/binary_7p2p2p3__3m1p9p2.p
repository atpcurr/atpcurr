%theorem: plus(plus(plus(7,2),2),3) = plus(plus(mul(3,1),9),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n1,n1)) = plus(plus(mul(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),b(n0,n1))).