%theorem: mul(plus(mul(4,3),3),8) = plus(mul(mul(7,2),8),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).