%theorem: plus(mul(plus(2,5),4),2) = mul(mul(mul(5,1),2),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)) = mul(mul(mul(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n1,n1))).