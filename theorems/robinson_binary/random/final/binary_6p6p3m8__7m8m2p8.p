%theorem: mul(plus(plus(6,6),3),8) = plus(mul(mul(7,8),2),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(mul(mul(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).