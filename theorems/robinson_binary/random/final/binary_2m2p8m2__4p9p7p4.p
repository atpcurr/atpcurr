%theorem: mul(plus(mul(2,2),8),2) = plus(plus(plus(4,9),7),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).