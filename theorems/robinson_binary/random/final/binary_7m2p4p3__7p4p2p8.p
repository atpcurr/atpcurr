%theorem: plus(plus(mul(7,2),4),3) = plus(plus(plus(7,4),2),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),b(n1,n1)) = plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).