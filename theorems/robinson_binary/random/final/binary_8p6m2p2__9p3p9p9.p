%theorem: plus(mul(plus(8,6),2),2) = plus(plus(plus(9,3),9),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n0,n1)) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).