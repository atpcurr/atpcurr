%theorem: plus(plus(plus(9,4),3),9) = plus(plus(mul(9,2),5),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1))).