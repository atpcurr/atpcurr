%theorem: plus(mul(plus(7,7),1),2) = plus(plus(mul(1,7),3),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,n1)) = plus(plus(mul(n1,b(n1,b(n1,n1))),b(n1,n1)),b(n0,b(n1,n1)))).