%theorem: plus(plus(plus(2,4),9),7) = mul(mul(plus(5,6),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,n1))).