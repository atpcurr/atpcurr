%theorem: mul(plus(plus(5,5),3),2) = plus(plus(plus(8,4),6),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n0,n1)) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).