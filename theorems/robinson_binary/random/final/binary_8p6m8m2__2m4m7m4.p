%theorem: mul(mul(plus(8,6),8),2) = mul(mul(mul(2,4),7),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = mul(mul(mul(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).