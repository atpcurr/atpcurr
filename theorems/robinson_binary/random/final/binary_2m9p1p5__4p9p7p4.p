%theorem: plus(plus(mul(2,9),1),5) = plus(plus(plus(4,9),7),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1))) = plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).