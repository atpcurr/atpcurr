%theorem: plus(plus(mul(2,9),1),5) = mul(plus(plus(2,2),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1)))).