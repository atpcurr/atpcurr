%theorem: plus(mul(plus(6,6),5),6) = mul(plus(plus(7,2),2),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n1,n1)))).