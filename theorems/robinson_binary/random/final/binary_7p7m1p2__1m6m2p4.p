%theorem: plus(mul(plus(7,7),1),2) = plus(mul(mul(1,6),2),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,n1)) = plus(mul(mul(n1,b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).