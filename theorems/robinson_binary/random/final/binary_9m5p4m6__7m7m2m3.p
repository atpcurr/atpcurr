%theorem: mul(plus(mul(9,5),4),6) = mul(mul(mul(7,7),2),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = mul(mul(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,n1)),b(n1,n1))).