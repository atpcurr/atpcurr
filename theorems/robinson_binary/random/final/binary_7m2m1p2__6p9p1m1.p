%theorem: plus(mul(mul(7,2),1),2) = mul(plus(plus(6,9),1),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),n1),b(n0,n1)) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1),n1)).