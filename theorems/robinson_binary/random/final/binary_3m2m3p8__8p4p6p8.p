%theorem: plus(mul(mul(3,2),3),8) = plus(plus(plus(8,4),6),8)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).