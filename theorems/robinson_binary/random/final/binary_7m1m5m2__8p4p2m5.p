%theorem: mul(mul(mul(7,1),5),2) = mul(plus(plus(8,4),2),5)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),n1),b(n1,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1)))).