%theorem: mul(mul(plus(3,7),7),4) = mul(mul(mul(5,2),4),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = mul(mul(mul(b(n1,b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).