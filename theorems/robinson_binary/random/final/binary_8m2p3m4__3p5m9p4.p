%theorem: mul(plus(mul(8,2),3),4) = plus(mul(plus(3,5),9),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))) = plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).