%theorem: plus(plus(plus(4,3),9),7) = plus(plus(plus(1,6),7),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = plus(plus(plus(n1,b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).