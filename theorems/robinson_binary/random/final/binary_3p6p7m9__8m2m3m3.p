%theorem: mul(plus(plus(3,6),7),9) = mul(mul(mul(8,2),3),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n1,n1))).