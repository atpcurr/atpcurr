%theorem: plus(mul(mul(3,4),6),3) = mul(plus(plus(2,6),7),5)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1)) = mul(plus(plus(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).