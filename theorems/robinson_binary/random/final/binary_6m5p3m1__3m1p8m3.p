%theorem: mul(plus(mul(6,5),3),1) = mul(plus(mul(3,1),8),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)),n1) = mul(plus(mul(b(n1,n1),n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1))).