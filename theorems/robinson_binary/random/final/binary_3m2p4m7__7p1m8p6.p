%theorem: mul(plus(mul(3,2),4),7) = plus(mul(plus(7,1),8),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n1,b(n1,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).