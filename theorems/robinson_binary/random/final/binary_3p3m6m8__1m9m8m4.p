%theorem: mul(mul(plus(3,3),6),8) = mul(mul(mul(1,9),8),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).