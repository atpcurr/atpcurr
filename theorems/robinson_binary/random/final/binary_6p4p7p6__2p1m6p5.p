%theorem: plus(plus(plus(6,4),7),6) = plus(mul(plus(2,1),6),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,n1),n1),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).