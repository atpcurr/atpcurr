%theorem: mul(mul(mul(9,6),2),3) = mul(mul(mul(9,1),9),4)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n1,n1)) = mul(mul(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).