%theorem: mul(plus(plus(6,2),2),4) = mul(mul(mul(5,1),1),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1))) = mul(mul(mul(b(n1,b(n0,n1)),n1),n1),b(n0,b(n0,b(n0,n1))))).