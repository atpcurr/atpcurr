%theorem: mul(plus(mul(5,3),4),1) = plus(plus(mul(4,2),5),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),n1) = plus(plus(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).