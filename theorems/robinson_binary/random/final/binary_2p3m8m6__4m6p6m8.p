%theorem: mul(mul(plus(2,3),8),6) = mul(plus(mul(4,6),6),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).