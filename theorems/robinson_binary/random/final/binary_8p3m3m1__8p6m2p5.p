%theorem: mul(mul(plus(8,3),3),1) = plus(mul(plus(8,6),2),5)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1)),n1) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,n1)))).