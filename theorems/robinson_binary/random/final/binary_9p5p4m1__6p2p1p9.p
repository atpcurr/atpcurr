%theorem: mul(plus(plus(9,5),4),1) = plus(plus(plus(6,2),1),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),n1) = plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),n1),b(n1,b(n0,b(n0,n1))))).