%theorem: plus(plus(plus(3,4),8),9) = mul(plus(plus(7,4),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),n1),b(n0,n1))).