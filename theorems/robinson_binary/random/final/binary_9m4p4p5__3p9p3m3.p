%theorem: plus(plus(mul(9,4),4),5) = mul(plus(plus(3,9),3),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,n1))).