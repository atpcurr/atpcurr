%theorem: mul(plus(plus(3,2),4),6) = plus(mul(mul(9,1),5),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = plus(mul(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).