%theorem: plus(mul(plus(3,8),5),2) = plus(mul(mul(6,3),3),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,n1)) = plus(mul(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,n1))).