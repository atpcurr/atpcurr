%theorem: mul(plus(plus(6,9),6),1) = plus(mul(plus(6,4),2),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),n1) = plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)),n1)).