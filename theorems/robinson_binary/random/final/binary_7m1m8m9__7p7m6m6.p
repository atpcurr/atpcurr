%theorem: mul(mul(mul(7,1),8),9) = mul(mul(plus(7,7),6),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).