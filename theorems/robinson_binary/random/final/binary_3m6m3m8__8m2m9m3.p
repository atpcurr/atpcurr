%theorem: mul(mul(mul(3,6),3),8) = mul(mul(mul(8,2),9),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).