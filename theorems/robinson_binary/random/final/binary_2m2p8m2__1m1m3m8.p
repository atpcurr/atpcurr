%theorem: mul(plus(mul(2,2),8),2) = mul(mul(mul(1,1),3),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = mul(mul(mul(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).