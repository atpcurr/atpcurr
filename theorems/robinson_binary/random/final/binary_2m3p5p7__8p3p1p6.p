%theorem: plus(plus(mul(2,3),5),7) = plus(plus(plus(8,3),1),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),n1),b(n0,b(n1,n1)))).