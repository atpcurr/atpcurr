%theorem: plus(plus(plus(4,7),9),4) = plus(plus(mul(4,3),4),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).