%theorem: mul(plus(plus(3,7),3),6) = plus(plus(mul(9,8),5),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),n1)).