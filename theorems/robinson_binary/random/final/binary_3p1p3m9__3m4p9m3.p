%theorem: mul(plus(plus(3,1),3),9) = mul(plus(mul(3,4),9),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).