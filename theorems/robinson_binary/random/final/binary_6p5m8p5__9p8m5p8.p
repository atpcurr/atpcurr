%theorem: plus(mul(plus(6,5),8),5) = plus(mul(plus(9,8),5),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).