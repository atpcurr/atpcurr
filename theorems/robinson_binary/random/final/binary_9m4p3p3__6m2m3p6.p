%theorem: plus(plus(mul(9,4),3),3) = plus(mul(mul(6,2),3),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1)) = plus(mul(mul(b(n0,b(n1,n1)),b(n0,n1)),b(n1,n1)),b(n0,b(n1,n1)))).