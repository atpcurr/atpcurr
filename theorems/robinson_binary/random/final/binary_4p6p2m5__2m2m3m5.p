%theorem: mul(plus(plus(4,6),2),5) = mul(mul(mul(2,2),3),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,n1))) = mul(mul(mul(b(n0,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1)))).