%theorem: plus(plus(plus(6,4),7),6) = plus(mul(mul(7,2),1),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = plus(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),n1),b(n1,b(n0,b(n0,n1))))).