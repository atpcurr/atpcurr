%theorem: plus(mul(mul(7,3),3),9) = mul(mul(mul(2,9),4),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),n1)).