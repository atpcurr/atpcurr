%theorem: mul(plus(mul(5,1),7),4) = mul(plus(mul(1,4),8),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(mul(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).