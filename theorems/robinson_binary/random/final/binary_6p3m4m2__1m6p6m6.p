%theorem: mul(mul(plus(6,3),4),2) = mul(plus(mul(1,6),6),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(mul(n1,b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).