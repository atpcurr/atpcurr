%theorem: mul(plus(mul(6,8),4),1) = mul(plus(plus(9,3),1),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),n1) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),n1),b(n0,b(n0,n1)))).