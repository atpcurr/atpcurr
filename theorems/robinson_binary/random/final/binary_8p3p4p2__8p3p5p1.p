%theorem: plus(plus(plus(8,3),4),2) = plus(plus(plus(8,3),5),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))),n1)).