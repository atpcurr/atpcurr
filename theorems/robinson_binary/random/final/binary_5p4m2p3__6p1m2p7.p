%theorem: plus(mul(plus(5,4),2),3) = plus(mul(plus(6,1),2),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)) = plus(mul(plus(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n1,b(n1,n1)))).