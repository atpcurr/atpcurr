%theorem: plus(plus(plus(9,1),1),7) = plus(plus(plus(2,5),5),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),n1),n1),b(n1,b(n1,n1))) = plus(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).