%theorem: plus(mul(mul(6,1),2),6) = plus(plus(mul(1,2),7),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).