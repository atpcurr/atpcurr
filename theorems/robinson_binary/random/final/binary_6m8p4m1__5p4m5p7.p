%theorem: mul(plus(mul(6,8),4),1) = plus(mul(plus(5,4),5),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),n1) = plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1)))).