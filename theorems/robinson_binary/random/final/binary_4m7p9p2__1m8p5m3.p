%theorem: plus(plus(mul(4,7),9),2) = mul(plus(mul(1,8),5),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(mul(n1,b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1))).