%theorem: plus(plus(mul(2,7),6),1) = plus(plus(plus(1,9),5),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),n1) = plus(plus(plus(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).