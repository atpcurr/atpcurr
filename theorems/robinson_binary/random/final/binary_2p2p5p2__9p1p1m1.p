%theorem: plus(plus(plus(2,2),5),2) = mul(plus(plus(9,1),1),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),n1),n1),n1)).