%theorem: mul(plus(mul(2,2),8),2) = plus(plus(mul(2,9),1),5)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = plus(plus(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1)))).