%theorem: mul(plus(plus(7,6),4),5) = plus(mul(plus(8,3),7),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).