%theorem: mul(plus(plus(5,7),4),2) = plus(mul(mul(3,8),1),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = plus(mul(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1))))).