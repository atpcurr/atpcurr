%theorem: plus(mul(plus(6,4),7),5) = mul(plus(plus(2,6),7),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).