%theorem: mul(plus(mul(9,5),3),1) = mul(plus(plus(8,2),6),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,n1)),n1) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))),b(n1,n1))).