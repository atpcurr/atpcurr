%theorem: mul(mul(plus(5,3),6),7) = mul(mul(mul(2,8),7),3)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = mul(mul(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1))).