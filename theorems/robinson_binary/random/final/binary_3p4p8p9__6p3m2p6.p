%theorem: plus(plus(plus(3,4),8),9) = plus(mul(plus(6,3),2),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,n1)),b(n0,b(n1,n1)))).