%theorem: mul(mul(mul(8,6),2),1) = mul(plus(plus(5,5),6),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),n1) = mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).