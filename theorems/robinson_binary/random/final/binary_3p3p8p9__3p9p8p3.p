%theorem: plus(plus(plus(3,3),8),9) = plus(plus(plus(3,9),8),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,n1))).