%theorem: mul(mul(mul(2,5),3),5) = mul(plus(plus(9,7),9),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,n1),b(n1,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).