%theorem: plus(plus(mul(5,6),4),6) = mul(plus(plus(8,8),4),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).