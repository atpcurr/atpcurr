%theorem: plus(plus(mul(5,3),6),6) = plus(mul(mul(3,2),3),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = plus(mul(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).