%theorem: plus(mul(mul(9,3),2),2) = plus(plus(mul(9,5),6),5)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n0,n1)) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).