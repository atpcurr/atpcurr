%theorem: plus(mul(plus(6,6),5),6) = plus(plus(mul(7,7),8),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).