%theorem: mul(plus(plus(3,3),3),9) = mul(mul(mul(9,1),1),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n1,b(n0,b(n0,n1))),n1),n1),b(n1,b(n0,b(n0,n1))))).