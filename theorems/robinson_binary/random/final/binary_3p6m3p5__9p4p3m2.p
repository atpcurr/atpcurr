%theorem: plus(mul(plus(3,6),3),5) = mul(plus(plus(9,4),3),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n1,b(n0,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1))).