%theorem: plus(plus(mul(8,9),5),3) = mul(plus(plus(6,2),2),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1)) = mul(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).