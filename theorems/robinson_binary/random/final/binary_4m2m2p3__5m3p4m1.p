%theorem: plus(mul(mul(4,2),2),3) = mul(plus(mul(5,3),4),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,n1)),b(n1,n1)) = mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),n1)).