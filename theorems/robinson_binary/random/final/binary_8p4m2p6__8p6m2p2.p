%theorem: plus(mul(plus(8,4),2),6) = plus(mul(plus(8,6),2),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n0,n1))).