%theorem: plus(mul(plus(2,6),2),4) = mul(plus(plus(6,7),7),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),n1)).