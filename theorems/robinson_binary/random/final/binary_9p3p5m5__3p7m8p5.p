%theorem: mul(plus(plus(9,3),5),5) = plus(mul(plus(3,7),8),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = plus(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).