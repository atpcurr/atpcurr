%theorem: mul(mul(mul(6,8),6),2) = mul(mul(plus(4,5),8),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,n1)) = mul(mul(plus(b(n0,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).