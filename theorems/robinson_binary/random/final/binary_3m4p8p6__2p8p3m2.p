%theorem: plus(plus(mul(3,4),8),6) = mul(plus(plus(2,8),3),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,n1))).