%theorem: mul(mul(plus(5,1),5),2) = mul(plus(mul(5,5),5),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,n1)) = mul(plus(mul(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1))).