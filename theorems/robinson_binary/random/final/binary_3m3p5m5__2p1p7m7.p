%theorem: mul(plus(mul(3,3),5),5) = mul(plus(plus(2,1),7),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,n1),n1),b(n1,b(n1,n1))),b(n1,b(n1,n1)))).