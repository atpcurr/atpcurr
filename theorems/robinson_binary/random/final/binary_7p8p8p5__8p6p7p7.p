%theorem: plus(plus(plus(7,8),8),5) = plus(plus(plus(8,6),7),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n1,n1)))).