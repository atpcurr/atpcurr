%theorem: plus(mul(mul(3,5),6),6) = mul(mul(plus(4,4),4),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1))).