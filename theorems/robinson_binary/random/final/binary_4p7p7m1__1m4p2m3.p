%theorem: mul(plus(plus(4,7),7),1) = mul(plus(mul(1,4),2),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),n1) = mul(plus(mul(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1))).