%theorem: mul(plus(plus(8,5),7),3) = mul(plus(plus(6,3),1),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),n1),b(n0,b(n1,n1)))).