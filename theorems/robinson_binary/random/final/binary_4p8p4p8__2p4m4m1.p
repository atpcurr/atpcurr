%theorem: plus(plus(plus(4,8),4),8) = mul(mul(plus(2,4),4),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1)).