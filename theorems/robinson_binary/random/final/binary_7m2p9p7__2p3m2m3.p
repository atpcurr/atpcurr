%theorem: plus(plus(mul(7,2),9),7) = mul(mul(plus(2,3),2),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,n1))).