%theorem: mul(mul(plus(4,6),4),1) = plus(mul(mul(3,4),3),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),n1) = plus(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,n1)))).