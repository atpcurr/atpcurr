%theorem: mul(plus(plus(5,9),1),8) = mul(mul(mul(2,5),2),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1)))).