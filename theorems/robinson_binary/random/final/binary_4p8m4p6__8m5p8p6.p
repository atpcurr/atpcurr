%theorem: plus(mul(plus(4,8),4),6) = plus(plus(mul(8,5),8),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).