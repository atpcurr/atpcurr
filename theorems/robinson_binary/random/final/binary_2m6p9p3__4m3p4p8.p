%theorem: plus(plus(mul(2,6),9),3) = plus(plus(mul(4,3),4),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).