%theorem: plus(plus(plus(4,7),1),5) = mul(plus(plus(6,5),6),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n1,n1))),n1)).