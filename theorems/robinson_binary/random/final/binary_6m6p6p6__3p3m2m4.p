%theorem: plus(plus(mul(6,6),6),6) = mul(mul(plus(3,3),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1)))).