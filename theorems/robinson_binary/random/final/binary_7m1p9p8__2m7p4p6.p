%theorem: plus(plus(mul(7,1),9),8) = plus(plus(mul(2,7),4),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).