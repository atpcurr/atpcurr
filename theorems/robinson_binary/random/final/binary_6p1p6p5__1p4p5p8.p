%theorem: plus(plus(plus(6,1),6),5) = plus(plus(plus(1,4),5),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = plus(plus(plus(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).