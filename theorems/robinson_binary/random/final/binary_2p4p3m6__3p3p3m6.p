%theorem: mul(plus(plus(2,4),3),6) = mul(plus(plus(3,3),3),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))) = mul(plus(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n0,b(n1,n1)))).