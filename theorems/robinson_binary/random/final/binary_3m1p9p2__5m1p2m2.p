%theorem: plus(plus(mul(3,1),9),2) = mul(plus(mul(5,1),2),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(mul(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n0,n1))).