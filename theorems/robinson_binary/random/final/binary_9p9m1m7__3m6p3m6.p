%theorem: mul(mul(plus(9,9),1),7) = mul(plus(mul(3,6),3),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n1,n1))) = mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n1,n1)))).