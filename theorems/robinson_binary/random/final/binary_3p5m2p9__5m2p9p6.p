%theorem: plus(mul(plus(3,5),2),9) = plus(plus(mul(5,2),9),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).