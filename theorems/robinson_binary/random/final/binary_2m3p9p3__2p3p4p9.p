%theorem: plus(plus(mul(2,3),9),3) = plus(plus(plus(2,3),4),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(plus(b(n0,n1),b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).