%theorem: mul(mul(mul(9,6),1),1) = mul(plus(plus(3,2),4),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),n1),n1) = mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).