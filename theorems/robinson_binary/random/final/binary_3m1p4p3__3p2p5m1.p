%theorem: plus(plus(mul(3,1),4),3) = mul(plus(plus(3,2),5),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),n1),b(n0,b(n0,n1))),b(n1,n1)) = mul(plus(plus(b(n1,n1),b(n0,n1)),b(n1,b(n0,n1))),n1)).