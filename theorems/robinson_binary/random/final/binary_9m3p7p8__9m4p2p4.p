%theorem: plus(plus(mul(9,3),7),8) = plus(plus(mul(9,4),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1)))).