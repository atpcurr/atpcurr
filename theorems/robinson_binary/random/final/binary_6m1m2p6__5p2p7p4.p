%theorem: plus(mul(mul(6,1),2),6) = plus(plus(plus(5,2),7),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).