%theorem: plus(plus(plus(5,9),4),2) = plus(plus(plus(2,8),9),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),n1)).