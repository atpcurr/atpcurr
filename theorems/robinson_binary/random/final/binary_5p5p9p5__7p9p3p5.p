%theorem: plus(plus(plus(5,5),9),5) = plus(plus(plus(7,9),3),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,n1)))).