%theorem: mul(mul(plus(4,2),5),8) = mul(plus(mul(4,6),6),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).