%theorem: plus(plus(mul(3,1),4),3) = plus(plus(plus(4,1),2),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),n1),b(n0,b(n0,n1))),b(n1,n1)) = plus(plus(plus(b(n0,b(n0,n1)),n1),b(n0,n1)),b(n1,n1))).