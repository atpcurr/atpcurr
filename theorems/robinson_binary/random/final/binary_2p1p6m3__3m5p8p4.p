%theorem: mul(plus(plus(2,1),6),3) = plus(plus(mul(3,5),8),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),n1),b(n0,b(n1,n1))),b(n1,n1)) = plus(plus(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).