%theorem: mul(mul(plus(2,3),6),9) = mul(mul(mul(6,5),1),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1))))).