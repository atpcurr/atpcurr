%theorem: plus(plus(mul(7,8),6),6) = mul(plus(plus(5,7),5),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).