%theorem: mul(plus(plus(4,8),1),1) = plus(plus(plus(1,5),2),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1),n1) = plus(plus(plus(n1,b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1)))).