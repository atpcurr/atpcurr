%theorem: plus(plus(plus(6,8),7),7) = mul(plus(plus(6,3),5),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1))).