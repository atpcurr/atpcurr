%theorem: plus(plus(plus(9,1),8),3) = plus(plus(plus(4,3),5),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).