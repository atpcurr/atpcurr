%theorem: mul(plus(plus(4,9),7),3) = plus(plus(mul(8,6),4),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1)) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).