%theorem: plus(mul(plus(6,4),2),1) = plus(mul(plus(2,3),3),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)),n1) = plus(mul(plus(b(n0,n1),b(n1,n1)),b(n1,n1)),b(n0,b(n1,n1)))).