%theorem: mul(mul(mul(4,9),2),1) = mul(plus(plus(2,5),2),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),n1) = mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).