%theorem: plus(mul(mul(4,3),3),7) = plus(plus(mul(5,6),9),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n1,n1)),b(n1,b(n1,n1))) = plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).