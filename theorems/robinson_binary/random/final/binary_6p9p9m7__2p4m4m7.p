%theorem: mul(plus(plus(6,9),9),7) = mul(mul(plus(2,4),4),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).