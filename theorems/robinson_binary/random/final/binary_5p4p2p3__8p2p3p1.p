%theorem: plus(plus(plus(5,4),2),3) = plus(plus(plus(8,2),3),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),n1)).