%theorem: mul(plus(mul(6,5),3),1) = plus(mul(plus(4,1),6),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)),n1) = plus(mul(plus(b(n0,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n1,n1))).