%theorem: mul(plus(plus(6,9),1),1) = plus(plus(mul(3,4),2),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1),n1) = plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1))).