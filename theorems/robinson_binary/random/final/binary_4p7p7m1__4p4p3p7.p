%theorem: mul(plus(plus(4,7),7),1) = plus(plus(plus(4,4),3),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),n1) = plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1)))).