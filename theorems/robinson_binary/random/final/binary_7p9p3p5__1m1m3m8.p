%theorem: plus(plus(plus(7,9),3),5) = mul(mul(mul(1,1),3),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,n1))) = mul(mul(mul(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).