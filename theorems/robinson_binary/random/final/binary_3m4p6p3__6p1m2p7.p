%theorem: plus(plus(mul(3,4),6),3) = plus(mul(plus(6,1),2),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1)) = plus(mul(plus(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n1,b(n1,n1)))).