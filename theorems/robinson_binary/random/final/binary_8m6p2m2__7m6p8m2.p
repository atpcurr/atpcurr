%theorem: mul(plus(mul(8,6),2),2) = mul(plus(mul(7,6),8),2)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n0,n1)) = mul(plus(mul(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1))).