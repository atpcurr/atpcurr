%theorem: mul(plus(mul(2,8),3),4) = plus(plus(mul(8,8),5),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n1,n1)))).