%theorem: mul(plus(plus(2,5),1),9) = mul(plus(mul(1,6),6),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(n1,b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).