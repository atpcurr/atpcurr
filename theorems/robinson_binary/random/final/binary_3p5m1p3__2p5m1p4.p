%theorem: plus(mul(plus(3,5),1),3) = plus(mul(plus(2,5),1),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),n1),b(n1,n1)) = plus(mul(plus(b(n0,n1),b(n1,b(n0,n1))),n1),b(n0,b(n0,n1)))).