%theorem: plus(plus(mul(3,8),3),9) = plus(mul(mul(4,4),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1)))).