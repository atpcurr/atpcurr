%theorem: plus(mul(plus(7,7),1),2) = plus(plus(plus(3,5),2),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,n1)) = plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1)))).