%theorem: plus(plus(mul(3,6),6),7) = plus(mul(mul(1,5),5),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(mul(mul(n1,b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).