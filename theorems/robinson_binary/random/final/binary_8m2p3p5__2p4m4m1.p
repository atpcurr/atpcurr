%theorem: plus(plus(mul(8,2),3),5) = mul(mul(plus(2,4),4),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))) = mul(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1)).