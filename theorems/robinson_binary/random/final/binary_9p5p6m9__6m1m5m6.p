%theorem: mul(plus(plus(9,5),6),9) = mul(mul(mul(6,1),5),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n1,n1)),n1),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).