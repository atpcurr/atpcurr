%theorem: mul(mul(mul(5,6),4),2) = mul(mul(plus(6,6),5),4)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).