%theorem: plus(mul(plus(7,1),8),6) = mul(plus(mul(1,5),5),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(mul(n1,b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1)))).