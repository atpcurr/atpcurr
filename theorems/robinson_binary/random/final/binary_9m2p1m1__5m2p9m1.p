%theorem: mul(plus(mul(9,2),1),1) = mul(plus(mul(5,2),9),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),n1),n1) = mul(plus(mul(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1)).