%theorem: mul(plus(plus(3,2),4),4) = mul(plus(mul(1,4),5),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = mul(plus(mul(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).