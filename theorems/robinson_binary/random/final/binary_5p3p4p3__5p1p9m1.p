%theorem: plus(plus(plus(5,3),4),3) = mul(plus(plus(5,1),9),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n1,n1)) = mul(plus(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,b(n0,n1)))),n1)).