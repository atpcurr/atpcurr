%theorem: mul(plus(plus(2,2),6),1) = plus(plus(mul(5,1),3),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,b(n1,n1))),n1) = plus(plus(mul(b(n1,b(n0,n1)),n1),b(n1,n1)),b(n0,n1))).