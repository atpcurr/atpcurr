%theorem: plus(plus(plus(5,4),2),6) = plus(mul(plus(4,1),2),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,n1)),n1),b(n0,n1)),b(n1,b(n1,n1)))).