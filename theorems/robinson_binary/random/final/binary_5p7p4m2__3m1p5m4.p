%theorem: mul(plus(plus(5,7),4),2) = mul(plus(mul(3,1),5),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(mul(b(n1,n1),n1),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).