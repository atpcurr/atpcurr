%theorem: mul(plus(mul(2,6),3),8) = mul(mul(mul(6,4),5),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1)).