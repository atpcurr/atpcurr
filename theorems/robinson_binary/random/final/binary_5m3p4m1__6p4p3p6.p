%theorem: mul(plus(mul(5,3),4),1) = plus(plus(plus(6,4),3),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),n1) = plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1)))).