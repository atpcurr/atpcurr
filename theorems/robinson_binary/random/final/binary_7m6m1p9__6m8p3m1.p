%theorem: plus(mul(mul(7,6),1),9) = mul(plus(mul(6,8),3),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n0,b(n1,n1))),n1),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),n1)).