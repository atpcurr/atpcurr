%theorem: plus(plus(mul(8,7),8),8) = mul(plus(plus(2,5),2),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1))))).