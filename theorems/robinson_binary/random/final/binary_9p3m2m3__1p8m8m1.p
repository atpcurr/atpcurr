%theorem: mul(mul(plus(9,3),2),3) = mul(mul(plus(1,8),8),1)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n1,n1)) = mul(mul(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),n1)).