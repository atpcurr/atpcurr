%theorem: mul(plus(mul(5,3),5),3) = mul(plus(plus(7,2),3),5)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1)))).