%theorem: plus(plus(plus(8,4),6),8) = plus(mul(plus(1,5),3),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = plus(mul(plus(n1,b(n1,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).