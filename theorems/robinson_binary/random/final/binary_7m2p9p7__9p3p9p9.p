%theorem: plus(plus(mul(7,2),9),7) = plus(plus(plus(9,3),9),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).