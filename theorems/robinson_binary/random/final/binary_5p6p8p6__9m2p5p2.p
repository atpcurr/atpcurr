%theorem: plus(plus(plus(5,6),8),6) = plus(plus(mul(9,2),5),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1))).