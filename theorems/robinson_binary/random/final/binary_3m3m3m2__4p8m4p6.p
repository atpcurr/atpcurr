%theorem: mul(mul(mul(3,3),3),2) = plus(mul(plus(4,8),4),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n0,n1)) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).