%theorem: mul(plus(mul(3,1),1),5) = plus(mul(plus(1,3),3),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),n1),n1),b(n1,b(n0,n1))) = plus(mul(plus(n1,b(n1,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).