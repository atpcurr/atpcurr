%theorem: plus(plus(plus(3,8),6),9) = plus(plus(plus(8,4),6),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).