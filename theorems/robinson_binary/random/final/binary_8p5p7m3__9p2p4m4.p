%theorem: mul(plus(plus(8,5),7),3) = mul(plus(plus(9,2),4),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1)))).