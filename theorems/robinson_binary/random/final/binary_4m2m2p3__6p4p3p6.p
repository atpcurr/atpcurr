%theorem: plus(mul(mul(4,2),2),3) = plus(plus(plus(6,4),3),6)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,n1)),b(n1,n1)) = plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1)))).