%theorem: plus(mul(mul(6,3),3),3) = plus(mul(plus(1,7),6),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,n1)) = plus(mul(plus(n1,b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).