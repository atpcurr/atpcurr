%theorem: plus(plus(plus(5,2),7),4) = plus(plus(plus(4,4),3),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1)))).