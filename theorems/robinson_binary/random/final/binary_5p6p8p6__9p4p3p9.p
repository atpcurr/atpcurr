%theorem: plus(plus(plus(5,6),8),6) = plus(plus(plus(9,4),3),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).