%theorem: mul(mul(mul(3,8),1),6) = mul(plus(mul(8,2),8),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).