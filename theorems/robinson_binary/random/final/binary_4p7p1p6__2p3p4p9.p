%theorem: plus(plus(plus(4,7),1),6) = plus(plus(plus(2,3),4),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n0,b(n1,n1))) = plus(plus(plus(b(n0,n1),b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).