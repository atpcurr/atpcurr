%theorem: plus(mul(plus(7,3),9),1) = plus(mul(plus(4,8),7),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1)))).