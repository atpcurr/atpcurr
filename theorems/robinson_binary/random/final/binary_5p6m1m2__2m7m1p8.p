%theorem: mul(mul(plus(5,6),1),2) = plus(mul(mul(2,7),1),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,n1)) = plus(mul(mul(b(n0,n1),b(n1,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).