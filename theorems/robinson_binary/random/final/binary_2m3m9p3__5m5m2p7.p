%theorem: plus(mul(mul(2,3),9),3) = plus(mul(mul(5,5),2),7)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(mul(mul(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n1,n1)))).