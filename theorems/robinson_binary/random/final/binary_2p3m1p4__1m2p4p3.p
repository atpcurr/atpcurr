%theorem: plus(mul(plus(2,3),1),4) = plus(plus(mul(1,2),4),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,n1)),n1),b(n0,b(n0,n1))) = plus(plus(mul(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,n1))).