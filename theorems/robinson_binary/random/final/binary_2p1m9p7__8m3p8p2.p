%theorem: plus(mul(plus(2,1),9),7) = plus(plus(mul(8,3),8),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1))).