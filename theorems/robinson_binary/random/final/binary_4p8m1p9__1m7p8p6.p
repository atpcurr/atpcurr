%theorem: plus(mul(plus(4,8),1),9) = plus(plus(mul(1,7),8),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(n1,b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1)))).