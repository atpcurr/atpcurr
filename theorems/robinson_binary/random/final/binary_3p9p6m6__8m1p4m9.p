%theorem: mul(plus(plus(3,9),6),6) = mul(plus(mul(8,1),4),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).