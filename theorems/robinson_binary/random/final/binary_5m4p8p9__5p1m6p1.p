%theorem: plus(plus(mul(5,4),8),9) = plus(mul(plus(5,1),6),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n1,b(n0,n1)),n1),b(n0,b(n1,n1))),n1)).