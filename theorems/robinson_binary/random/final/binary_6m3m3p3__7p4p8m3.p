%theorem: plus(mul(mul(6,3),3),3) = mul(plus(plus(7,4),8),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,n1)) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,n1))).