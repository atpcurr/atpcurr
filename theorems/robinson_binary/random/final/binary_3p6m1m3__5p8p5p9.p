%theorem: mul(mul(plus(3,6),1),3) = plus(plus(plus(5,8),5),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n0,b(n1,n1))),n1),b(n1,n1)) = plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).