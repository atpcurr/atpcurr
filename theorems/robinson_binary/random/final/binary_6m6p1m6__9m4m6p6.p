%theorem: mul(plus(mul(6,6),1),6) = plus(mul(mul(9,4),6),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),b(n0,b(n1,n1))) = plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).