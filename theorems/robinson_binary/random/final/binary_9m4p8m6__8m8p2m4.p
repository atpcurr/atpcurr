%theorem: mul(plus(mul(9,4),8),6) = mul(plus(mul(8,8),2),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,n1)))).