%theorem: plus(mul(plus(5,6),5),9) = plus(plus(mul(8,7),3),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)),b(n1,b(n0,n1)))).