%theorem: mul(plus(plus(7,9),4),2) = plus(plus(mul(5,6),4),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).