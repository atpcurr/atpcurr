%theorem: plus(mul(plus(2,9),5),4) = plus(mul(plus(6,3),6),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = plus(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).