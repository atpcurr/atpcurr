%theorem: mul(plus(plus(4,9),7),3) = mul(mul(plus(5,1),5),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1)) = mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,n1))).