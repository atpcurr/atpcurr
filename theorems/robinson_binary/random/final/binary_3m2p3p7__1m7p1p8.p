%theorem: plus(plus(mul(3,2),3),7) = plus(plus(mul(1,7),1),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))) = plus(plus(mul(n1,b(n1,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).