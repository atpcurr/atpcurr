%theorem: plus(plus(plus(7,8),8),5) = plus(mul(plus(1,2),8),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = plus(mul(plus(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).