%theorem: plus(mul(plus(5,6),5),9) = mul(plus(mul(9,1),7),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).