%theorem: plus(plus(mul(8,3),2),8) = mul(plus(plus(9,1),7),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1))),b(n0,n1))).