%theorem: plus(mul(plus(2,5),4),2) = plus(mul(mul(1,3),7),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)) = plus(mul(mul(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).