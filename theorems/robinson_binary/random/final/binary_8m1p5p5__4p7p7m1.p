%theorem: plus(plus(mul(8,1),5),5) = mul(plus(plus(4,7),7),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),n1)).