%theorem: plus(plus(mul(2,2),8),8) = plus(mul(mul(4,2),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1)))).