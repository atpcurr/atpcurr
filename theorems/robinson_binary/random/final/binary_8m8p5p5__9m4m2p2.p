%theorem: plus(plus(mul(8,8),5),5) = plus(mul(mul(9,4),2),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1))).