%theorem: mul(mul(mul(4,9),1),2) = mul(plus(plus(1,1),6),9)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1),b(n0,n1)) = mul(plus(plus(n1,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).