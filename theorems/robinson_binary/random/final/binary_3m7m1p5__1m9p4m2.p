%theorem: plus(mul(mul(3,7),1),5) = mul(plus(mul(1,9),4),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1))) = mul(plus(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).