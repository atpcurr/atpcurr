%theorem: plus(plus(plus(4,3),7),4) = mul(plus(plus(4,9),5),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),n1)).