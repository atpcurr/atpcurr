%theorem: mul(mul(plus(4,2),5),8) = mul(mul(plus(7,9),3),5)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,n1)))).