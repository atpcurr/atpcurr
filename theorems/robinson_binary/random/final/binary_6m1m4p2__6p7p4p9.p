%theorem: plus(mul(mul(6,1),4),2) = plus(plus(plus(6,7),4),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).