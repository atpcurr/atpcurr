%theorem: plus(mul(plus(4,1),6),3) = mul(plus(mul(3,1),8),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n1,n1)) = mul(plus(mul(b(n1,n1),n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1))).