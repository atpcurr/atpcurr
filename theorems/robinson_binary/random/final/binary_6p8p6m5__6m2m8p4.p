%theorem: mul(plus(plus(6,8),6),5) = plus(mul(mul(6,2),8),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = plus(mul(mul(b(n0,b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).