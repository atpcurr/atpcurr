%theorem: plus(plus(mul(6,6),8),4) = mul(plus(mul(5,1),7),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(plus(mul(b(n1,b(n0,n1)),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).