%theorem: plus(mul(plus(3,4),6),2) = plus(mul(plus(2,8),4),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)) = plus(mul(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,n1)))).