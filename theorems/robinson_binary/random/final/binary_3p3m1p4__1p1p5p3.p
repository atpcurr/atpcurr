%theorem: plus(mul(plus(3,3),1),4) = plus(plus(plus(1,1),5),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,n1)),n1),b(n0,b(n0,n1))) = plus(plus(plus(n1,n1),b(n1,b(n0,n1))),b(n1,n1))).