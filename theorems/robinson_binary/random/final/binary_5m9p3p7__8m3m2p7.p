%theorem: plus(plus(mul(5,9),3),7) = plus(mul(mul(8,3),2),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n1,n1))) = plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1)))).