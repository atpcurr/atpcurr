%theorem: plus(mul(plus(7,7),1),2) = mul(plus(mul(2,5),6),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,n1)) = mul(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),n1)).