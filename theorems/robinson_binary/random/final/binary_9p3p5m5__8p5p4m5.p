%theorem: mul(plus(plus(9,3),5),5) = mul(plus(plus(8,5),4),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1)))).