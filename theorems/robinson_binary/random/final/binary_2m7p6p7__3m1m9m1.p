%theorem: plus(plus(mul(2,7),6),7) = mul(mul(mul(3,1),9),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = mul(mul(mul(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),n1)).