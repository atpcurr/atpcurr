%theorem: mul(mul(plus(5,6),2),5) = mul(mul(plus(7,4),5),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,n1))) = mul(mul(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1))).