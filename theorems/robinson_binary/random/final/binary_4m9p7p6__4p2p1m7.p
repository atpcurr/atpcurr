%theorem: plus(plus(mul(4,9),7),6) = mul(plus(plus(4,2),1),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n0,n1)),n1),b(n1,b(n1,n1)))).