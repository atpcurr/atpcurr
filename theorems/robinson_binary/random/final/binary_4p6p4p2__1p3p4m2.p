%theorem: plus(plus(plus(4,6),4),2) = mul(plus(plus(1,3),4),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(plus(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1))).