%theorem: plus(mul(plus(5,4),5),7) = mul(plus(plus(9,3),1),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),n1),b(n0,b(n0,n1)))).