%theorem: plus(plus(plus(7,2),7),5) = plus(mul(plus(4,8),1),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n0,b(n0,n1))))).