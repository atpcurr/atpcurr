%theorem: mul(plus(mul(5,6),9),3) = mul(plus(plus(4,5),4),9)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).