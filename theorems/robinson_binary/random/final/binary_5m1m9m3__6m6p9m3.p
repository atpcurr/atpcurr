%theorem: mul(mul(mul(5,1),9),3) = mul(plus(mul(6,6),9),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).