%theorem: mul(mul(plus(5,6),2),5) = plus(mul(mul(6,9),2),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,n1))) = plus(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,n1))).