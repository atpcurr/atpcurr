%theorem: mul(plus(mul(2,7),3),7) = mul(plus(plus(6,7),4),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n1,n1)),b(n1,b(n1,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).