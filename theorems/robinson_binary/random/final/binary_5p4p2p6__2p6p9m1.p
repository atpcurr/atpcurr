%theorem: plus(plus(plus(5,4),2),6) = mul(plus(plus(2,6),9),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),n1)).