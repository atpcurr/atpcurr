%theorem: mul(mul(mul(7,5),7),9) = mul(mul(mul(5,9),7),7)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1)))).