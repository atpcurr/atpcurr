%theorem: plus(mul(mul(6,1),2),6) = plus(plus(mul(8,1),5),5)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n1,b(n0,n1)))).