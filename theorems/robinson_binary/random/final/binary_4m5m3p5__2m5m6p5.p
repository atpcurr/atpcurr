%theorem: plus(mul(mul(4,5),3),5) = plus(mul(mul(2,5),6),5)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))) = plus(mul(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).