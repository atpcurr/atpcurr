%theorem: mul(plus(plus(2,2),6),4) = mul(plus(plus(1,1),3),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(plus(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).