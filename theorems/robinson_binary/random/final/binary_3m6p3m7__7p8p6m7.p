%theorem: mul(plus(mul(3,6),3),7) = mul(plus(plus(7,8),6),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n1,n1)))).