%theorem: plus(plus(plus(6,8),7),7) = plus(mul(plus(9,4),2),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1))).