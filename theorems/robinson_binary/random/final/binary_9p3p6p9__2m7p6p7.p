%theorem: plus(plus(plus(9,3),6),9) = plus(plus(mul(2,7),6),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1)))).