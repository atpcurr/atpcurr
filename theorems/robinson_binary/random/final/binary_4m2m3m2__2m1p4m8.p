%theorem: mul(mul(mul(4,2),3),2) = mul(plus(mul(2,1),4),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,n1)),b(n0,n1)) = mul(plus(mul(b(n0,n1),n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).