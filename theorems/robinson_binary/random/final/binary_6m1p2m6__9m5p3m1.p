%theorem: mul(plus(mul(6,1),2),6) = mul(plus(mul(9,5),3),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,n1)),n1)).