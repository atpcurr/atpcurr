%theorem: mul(plus(mul(3,5),5),6) = mul(plus(plus(6,6),3),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).