%theorem: mul(plus(plus(6,3),5),2) = plus(mul(plus(9,4),2),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)) = plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,n1))).