%theorem: mul(plus(mul(7,1),6),1) = plus(plus(plus(3,1),3),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),n1),b(n0,b(n1,n1))),n1) = plus(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n0,b(n1,n1)))).