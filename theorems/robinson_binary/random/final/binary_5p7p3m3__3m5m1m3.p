%theorem: mul(plus(plus(5,7),3),3) = mul(mul(mul(3,5),1),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,n1)),b(n1,n1)) = mul(mul(mul(b(n1,n1),b(n1,b(n0,n1))),n1),b(n1,n1))).