%theorem: plus(mul(plus(5,1),2),6) = plus(plus(mul(1,7),5),6)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(n1,b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).