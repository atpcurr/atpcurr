%theorem: mul(plus(plus(3,2),4),4) = plus(plus(mul(7,4),4),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = plus(plus(mul(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1)))).