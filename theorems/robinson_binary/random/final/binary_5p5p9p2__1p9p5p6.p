%theorem: plus(plus(plus(5,5),9),2) = plus(plus(plus(1,9),5),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = plus(plus(plus(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).