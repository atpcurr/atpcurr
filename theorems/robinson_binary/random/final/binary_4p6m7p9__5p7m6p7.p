%theorem: plus(mul(plus(4,6),7),9) = plus(mul(plus(5,7),6),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1)))).