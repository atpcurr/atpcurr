%theorem: plus(plus(plus(6,2),7),3) = plus(plus(plus(4,7),1),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n1,n1)) = plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n0,b(n1,n1)))).