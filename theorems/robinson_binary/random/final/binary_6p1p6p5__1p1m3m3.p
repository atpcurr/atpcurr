%theorem: plus(plus(plus(6,1),6),5) = mul(mul(plus(1,1),3),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = mul(mul(plus(n1,n1),b(n1,n1)),b(n1,n1))).