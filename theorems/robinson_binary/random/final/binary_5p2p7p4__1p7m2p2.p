%theorem: plus(plus(plus(5,2),7),4) = plus(mul(plus(1,7),2),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(mul(plus(n1,b(n1,b(n1,n1))),b(n0,n1)),b(n0,n1))).