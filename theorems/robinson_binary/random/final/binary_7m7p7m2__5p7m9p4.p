%theorem: mul(plus(mul(7,7),7),2) = plus(mul(plus(5,7),9),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,n1)) = plus(mul(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).