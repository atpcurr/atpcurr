%theorem: plus(plus(plus(9,9),7),7) = mul(plus(plus(9,4),3),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1))).