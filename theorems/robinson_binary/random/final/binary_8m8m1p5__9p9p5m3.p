%theorem: plus(mul(mul(8,8),1),5) = mul(plus(plus(9,9),5),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1))).