%theorem: mul(plus(mul(3,1),1),5) = plus(plus(plus(6,2),4),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),n1),n1),b(n1,b(n0,n1))) = plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).