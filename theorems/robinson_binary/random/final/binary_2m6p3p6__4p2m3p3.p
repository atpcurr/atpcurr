%theorem: plus(plus(mul(2,6),3),6) = plus(mul(plus(4,2),3),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,n1)),b(n1,n1))).