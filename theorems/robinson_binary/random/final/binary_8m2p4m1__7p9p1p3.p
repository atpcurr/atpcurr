%theorem: mul(plus(mul(8,2),4),1) = plus(plus(plus(7,9),1),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1))),n1) = plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1),b(n1,n1))).