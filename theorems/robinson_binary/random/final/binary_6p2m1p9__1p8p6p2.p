%theorem: plus(mul(plus(6,2),1),9) = plus(plus(plus(1,8),6),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,n1)),n1),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,n1))).