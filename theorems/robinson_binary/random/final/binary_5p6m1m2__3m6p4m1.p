%theorem: mul(mul(plus(5,6),1),2) = mul(plus(mul(3,6),4),1)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,n1)) = mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),n1)).