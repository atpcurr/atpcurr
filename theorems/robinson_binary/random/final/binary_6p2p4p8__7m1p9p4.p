%theorem: plus(plus(plus(6,2),4),8) = plus(plus(mul(7,1),9),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).