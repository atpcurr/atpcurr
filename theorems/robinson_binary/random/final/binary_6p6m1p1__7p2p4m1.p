%theorem: plus(mul(plus(6,6),1),1) = mul(plus(plus(7,2),4),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),n1) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,n1))),n1)).