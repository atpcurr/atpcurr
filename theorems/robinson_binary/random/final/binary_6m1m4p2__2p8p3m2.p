%theorem: plus(mul(mul(6,1),4),2) = mul(plus(plus(2,8),3),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,n1))).