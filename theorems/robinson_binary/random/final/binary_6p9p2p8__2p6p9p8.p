%theorem: plus(plus(plus(6,9),2),8) = plus(plus(plus(2,6),9),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).