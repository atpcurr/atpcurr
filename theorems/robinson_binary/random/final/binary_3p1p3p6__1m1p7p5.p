%theorem: plus(plus(plus(3,1),3),6) = plus(plus(mul(1,1),7),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n0,b(n1,n1))) = plus(plus(mul(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).