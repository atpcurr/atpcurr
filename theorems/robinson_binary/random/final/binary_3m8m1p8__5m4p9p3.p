%theorem: plus(mul(mul(3,8),1),8) = plus(plus(mul(5,4),9),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).