%theorem: mul(plus(plus(3,3),8),4) = mul(plus(plus(5,7),2),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).