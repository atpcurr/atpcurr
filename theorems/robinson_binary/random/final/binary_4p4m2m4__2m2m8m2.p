%theorem: mul(mul(plus(4,4),2),4) = mul(mul(mul(2,2),8),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1))) = mul(mul(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1))).