%theorem: plus(plus(plus(2,8),5),6) = plus(mul(plus(2,4),3),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1))).