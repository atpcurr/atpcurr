%theorem: plus(mul(plus(3,5),2),9) = plus(plus(plus(2,6),9),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).