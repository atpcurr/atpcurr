%theorem: plus(plus(plus(9,3),6),9) = mul(mul(mul(3,1),9),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),n1)).