%theorem: plus(plus(mul(9,5),6),5) = mul(plus(plus(2,4),1),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,n1),b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1))))).