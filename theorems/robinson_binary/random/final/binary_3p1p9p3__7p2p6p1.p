%theorem: plus(plus(plus(3,1),9),3) = plus(plus(plus(7,2),6),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n1,n1))),n1)).