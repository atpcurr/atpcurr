%theorem: plus(mul(plus(5,8),5),4) = mul(plus(plus(9,9),5),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1))).