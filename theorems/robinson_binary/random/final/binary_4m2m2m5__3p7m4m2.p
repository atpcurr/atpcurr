%theorem: mul(mul(mul(4,2),2),5) = mul(mul(plus(3,7),4),2)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))) = mul(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1))).