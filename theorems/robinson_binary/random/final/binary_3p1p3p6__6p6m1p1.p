%theorem: plus(plus(plus(3,1),3),6) = plus(mul(plus(6,6),1),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),n1),b(n1,n1)),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),n1)).