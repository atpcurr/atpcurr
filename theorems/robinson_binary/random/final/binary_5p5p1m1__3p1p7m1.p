%theorem: mul(plus(plus(5,5),1),1) = mul(plus(plus(3,1),7),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),n1),n1) = mul(plus(plus(b(n1,n1),n1),b(n1,b(n1,n1))),n1)).