%theorem: plus(plus(mul(2,6),9),3) = plus(mul(plus(2,7),2),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(mul(plus(b(n0,n1),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n1,n1)))).