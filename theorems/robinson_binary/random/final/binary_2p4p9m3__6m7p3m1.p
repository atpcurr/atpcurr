%theorem: mul(plus(plus(2,4),9),3) = mul(plus(mul(6,7),3),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(mul(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n1,n1)),n1)).