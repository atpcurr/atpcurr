%theorem: plus(plus(plus(5,7),1),7) = plus(mul(plus(2,6),2),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n1,b(n1,n1))) = plus(mul(plus(b(n0,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).