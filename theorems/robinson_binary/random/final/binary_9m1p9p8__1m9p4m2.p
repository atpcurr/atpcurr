%theorem: plus(plus(mul(9,1),9),8) = mul(plus(mul(1,9),4),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).