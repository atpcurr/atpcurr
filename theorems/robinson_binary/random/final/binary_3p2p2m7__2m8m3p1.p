%theorem: mul(plus(plus(3,2),2),7) = plus(mul(mul(2,8),3),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))) = plus(mul(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),n1)).