%theorem: plus(plus(plus(4,6),4),2) = plus(plus(mul(3,2),3),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1)))).