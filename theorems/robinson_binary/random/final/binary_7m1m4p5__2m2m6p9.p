%theorem: plus(mul(mul(7,1),4),5) = plus(mul(mul(2,2),6),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),n1),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = plus(mul(mul(b(n0,n1),b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).