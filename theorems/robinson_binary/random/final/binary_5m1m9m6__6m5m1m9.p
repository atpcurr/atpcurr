%theorem: mul(mul(mul(5,1),9),6) = mul(mul(mul(6,5),1),9)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1))))).