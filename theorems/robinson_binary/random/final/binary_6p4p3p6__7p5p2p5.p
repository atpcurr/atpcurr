%theorem: plus(plus(plus(6,4),3),6) = plus(plus(plus(7,5),2),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))) = plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1)))).