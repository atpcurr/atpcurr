%theorem: mul(plus(plus(2,8),3),2) = plus(plus(plus(6,7),4),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,n1)) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).