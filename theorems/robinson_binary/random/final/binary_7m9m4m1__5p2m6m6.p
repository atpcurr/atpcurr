%theorem: mul(mul(mul(7,9),4),1) = mul(mul(plus(5,2),6),6)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),n1) = mul(mul(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).