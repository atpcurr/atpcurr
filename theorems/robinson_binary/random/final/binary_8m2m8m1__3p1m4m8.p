%theorem: mul(mul(mul(8,2),8),1) = mul(mul(plus(3,1),4),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1) = mul(mul(plus(b(n1,n1),n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).