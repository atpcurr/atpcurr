%theorem: mul(mul(plus(6,6),4),5) = mul(mul(mul(5,6),4),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = mul(mul(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1))).