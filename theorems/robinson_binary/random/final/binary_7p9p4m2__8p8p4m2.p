%theorem: mul(plus(plus(7,9),4),2) = mul(plus(plus(8,8),4),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).