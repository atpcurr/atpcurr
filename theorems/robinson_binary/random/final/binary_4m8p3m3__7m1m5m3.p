%theorem: mul(plus(mul(4,8),3),3) = mul(mul(mul(7,1),5),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,n1)) = mul(mul(mul(b(n1,b(n1,n1)),n1),b(n1,b(n0,n1))),b(n1,n1))).