%theorem: plus(plus(mul(3,4),9),2) = plus(plus(plus(1,6),7),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = plus(plus(plus(n1,b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).