%theorem: mul(plus(mul(8,7),1),4) = plus(mul(mul(7,4),8),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),n1),b(n0,b(n0,n1))) = plus(mul(mul(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).