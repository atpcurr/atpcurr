%theorem: mul(plus(plus(2,5),2),8) = mul(mul(mul(4,9),1),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))) = mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1),b(n0,n1))).