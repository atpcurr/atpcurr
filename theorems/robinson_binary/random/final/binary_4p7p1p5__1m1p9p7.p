%theorem: plus(plus(plus(4,7),1),5) = plus(plus(mul(1,1),9),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1))) = plus(plus(mul(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).