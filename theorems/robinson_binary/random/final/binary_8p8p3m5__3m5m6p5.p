%theorem: mul(plus(plus(8,8),3),5) = plus(mul(mul(3,5),6),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,n1))) = plus(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).