%theorem: plus(mul(plus(9,8),6),3) = mul(mul(plus(4,3),5),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,n1)) = mul(mul(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1))).