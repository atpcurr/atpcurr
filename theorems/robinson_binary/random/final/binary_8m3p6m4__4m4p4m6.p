%theorem: mul(plus(mul(8,3),6),4) = mul(plus(mul(4,4),4),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).