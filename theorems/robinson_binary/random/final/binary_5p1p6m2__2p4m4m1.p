%theorem: mul(plus(plus(5,1),6),2) = mul(mul(plus(2,4),4),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n0,n1)) = mul(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1)).