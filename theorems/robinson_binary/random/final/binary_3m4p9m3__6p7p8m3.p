%theorem: mul(plus(mul(3,4),9),3) = mul(plus(plus(6,7),8),3)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,n1))).