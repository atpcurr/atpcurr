%theorem: plus(mul(plus(2,1),2),7) = plus(plus(plus(1,5),2),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),n1),b(n0,n1)),b(n1,b(n1,n1))) = plus(plus(plus(n1,b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1)))).