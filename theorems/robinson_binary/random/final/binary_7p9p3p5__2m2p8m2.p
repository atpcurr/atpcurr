%theorem: plus(plus(plus(7,9),3),5) = mul(plus(mul(2,2),8),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,n1))) = mul(plus(mul(b(n0,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1))).