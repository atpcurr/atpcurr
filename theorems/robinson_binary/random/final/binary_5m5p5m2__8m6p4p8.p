%theorem: mul(plus(mul(5,5),5),2) = plus(plus(mul(8,6),4),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).