%theorem: plus(plus(mul(7,8),6),6) = plus(mul(plus(6,6),5),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).