%theorem: plus(mul(mul(7,2),1),2) = plus(plus(plus(1,2),5),8)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),n1),b(n0,n1)) = plus(plus(plus(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).