%theorem: plus(plus(mul(3,8),5),5) = plus(plus(mul(3,9),3),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = plus(plus(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,n1)))).