%theorem: plus(plus(plus(7,9),3),6) = plus(plus(mul(6,3),6),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n1,n1))),n1)).