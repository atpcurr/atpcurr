%theorem: plus(mul(plus(2,3),9),2) = plus(mul(plus(3,3),7),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = plus(mul(plus(b(n1,n1),b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).