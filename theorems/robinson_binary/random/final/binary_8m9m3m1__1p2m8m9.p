%theorem: mul(mul(mul(8,9),3),1) = mul(mul(plus(1,2),8),9)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),n1) = mul(mul(plus(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).