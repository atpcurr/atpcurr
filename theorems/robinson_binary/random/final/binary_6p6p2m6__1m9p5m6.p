%theorem: mul(plus(plus(6,6),2),6) = mul(plus(mul(1,9),5),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).