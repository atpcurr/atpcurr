%theorem: mul(plus(plus(5,9),3),4) = plus(mul(plus(4,5),7),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).