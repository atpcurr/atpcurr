%theorem: mul(plus(mul(3,2),4),7) = mul(plus(mul(1,5),5),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = mul(plus(mul(n1,b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1)))).