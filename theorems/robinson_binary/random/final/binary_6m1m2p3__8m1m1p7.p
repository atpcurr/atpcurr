%theorem: plus(mul(mul(6,1),2),3) = plus(mul(mul(8,1),1),7)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n1,n1)) = plus(mul(mul(b(n0,b(n0,b(n0,n1))),n1),n1),b(n1,b(n1,n1)))).