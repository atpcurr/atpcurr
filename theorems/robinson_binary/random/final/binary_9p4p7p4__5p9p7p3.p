%theorem: plus(plus(plus(9,4),7),4) = plus(plus(plus(5,9),7),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1))).