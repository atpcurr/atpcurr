%theorem: plus(plus(mul(8,1),5),5) = plus(mul(plus(1,7),2),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = plus(mul(plus(n1,b(n1,b(n1,n1))),b(n0,n1)),b(n0,n1))).