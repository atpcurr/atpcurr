%theorem: plus(mul(mul(3,2),3),8) = plus(mul(plus(1,5),3),8)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(mul(plus(n1,b(n1,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).