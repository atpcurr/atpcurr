%theorem: plus(plus(plus(4,3),7),2) = plus(plus(plus(1,7),5),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n1,n1))),b(n0,n1)) = plus(plus(plus(n1,b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,n1))).