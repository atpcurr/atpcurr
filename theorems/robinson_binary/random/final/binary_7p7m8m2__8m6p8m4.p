%theorem: mul(mul(plus(7,7),8),2) = mul(plus(mul(8,6),8),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).