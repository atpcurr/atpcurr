%theorem: plus(mul(mul(3,7),1),5) = plus(plus(mul(9,1),9),8)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).