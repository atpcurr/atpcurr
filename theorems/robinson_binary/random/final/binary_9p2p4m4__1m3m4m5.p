%theorem: mul(plus(plus(9,2),4),4) = mul(mul(mul(1,3),4),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = mul(mul(mul(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1)))).