%theorem: plus(plus(plus(8,7),9),2) = mul(plus(plus(3,8),2),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,n1))).