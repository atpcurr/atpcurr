%theorem: plus(plus(mul(6,6),8),4) = mul(plus(mul(1,4),8),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(plus(mul(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).