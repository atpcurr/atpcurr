%theorem: plus(plus(mul(2,8),7),9) = plus(mul(mul(2,2),6),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,n1),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).