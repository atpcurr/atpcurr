%theorem: plus(mul(plus(5,4),3),9) = plus(mul(plus(2,2),7),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,n1),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).