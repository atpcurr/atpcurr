%theorem: plus(plus(plus(3,5),2),6) = mul(plus(mul(2,5),6),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),n1)).