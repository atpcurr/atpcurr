%theorem: plus(mul(plus(7,1),8),6) = mul(mul(mul(2,1),7),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = mul(mul(mul(b(n0,n1),n1),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).