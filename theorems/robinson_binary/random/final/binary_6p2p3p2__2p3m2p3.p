%theorem: plus(plus(plus(6,2),3),2) = plus(mul(plus(2,3),2),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n1,n1)),b(n0,n1)) = plus(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,n1))).