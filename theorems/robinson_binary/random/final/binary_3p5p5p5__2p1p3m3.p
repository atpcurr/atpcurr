%theorem: plus(plus(plus(3,5),5),5) = mul(plus(plus(2,1),3),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(b(n0,n1),n1),b(n1,n1)),b(n1,n1))).