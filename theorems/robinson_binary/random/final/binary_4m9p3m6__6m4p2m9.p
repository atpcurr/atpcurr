%theorem: mul(plus(mul(4,9),3),6) = mul(plus(mul(6,4),2),9)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1))))).