%theorem: plus(plus(mul(3,9),1),6) = mul(plus(plus(9,7),1),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n0,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),n1),b(n0,n1))).