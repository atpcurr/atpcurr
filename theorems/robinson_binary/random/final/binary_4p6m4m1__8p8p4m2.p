%theorem: mul(mul(plus(4,6),4),1) = mul(plus(plus(8,8),4),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),n1) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).