%theorem: plus(plus(plus(3,5),2),6) = plus(mul(mul(1,6),2),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))) = plus(mul(mul(n1,b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).