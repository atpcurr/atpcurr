%theorem: mul(plus(mul(3,2),4),7) = mul(mul(mul(2,1),7),5)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = mul(mul(mul(b(n0,n1),n1),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).