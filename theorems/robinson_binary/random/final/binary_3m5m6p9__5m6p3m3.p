%theorem: plus(mul(mul(3,5),6),9) = mul(plus(mul(5,6),3),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,n1)),b(n1,n1))).