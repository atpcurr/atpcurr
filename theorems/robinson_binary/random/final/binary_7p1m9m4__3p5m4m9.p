%theorem: mul(mul(plus(7,1),9),4) = mul(mul(plus(3,5),4),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).