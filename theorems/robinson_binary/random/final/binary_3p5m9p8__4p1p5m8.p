%theorem: plus(mul(plus(3,5),9),8) = mul(plus(plus(4,1),5),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n0,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).