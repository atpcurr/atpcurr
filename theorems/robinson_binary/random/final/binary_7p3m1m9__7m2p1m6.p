%theorem: mul(mul(plus(7,3),1),9) = mul(plus(mul(7,2),1),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n1,n1)),b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),n1),b(n0,b(n1,n1)))).