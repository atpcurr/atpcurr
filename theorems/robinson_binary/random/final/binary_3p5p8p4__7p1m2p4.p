%theorem: plus(plus(plus(3,5),8),4) = plus(mul(plus(7,1),2),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = plus(mul(plus(b(n1,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n0,n1)))).