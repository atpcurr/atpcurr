%theorem: plus(plus(mul(8,7),3),5) = mul(plus(mul(2,7),2),4)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)),b(n1,b(n0,n1))) = mul(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).