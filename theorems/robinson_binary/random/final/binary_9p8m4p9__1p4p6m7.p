%theorem: plus(mul(plus(9,8),4),9) = mul(plus(plus(1,4),6),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = mul(plus(plus(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1)))).