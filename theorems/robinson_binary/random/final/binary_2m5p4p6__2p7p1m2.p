%theorem: plus(plus(mul(2,5),4),6) = mul(plus(plus(2,7),1),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,n1),b(n1,b(n1,n1))),n1),b(n0,n1))).