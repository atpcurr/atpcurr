%theorem: plus(mul(plus(4,4),1),5) = plus(mul(mul(2,1),4),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))) = plus(mul(mul(b(n0,n1),n1),b(n0,b(n0,n1))),b(n1,b(n0,n1)))).