%theorem: mul(mul(plus(5,1),3),6) = mul(plus(plus(3,9),6),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,n1)),b(n0,b(n1,n1))) = mul(plus(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).