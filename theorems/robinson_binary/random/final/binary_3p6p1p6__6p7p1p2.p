%theorem: plus(plus(plus(3,6),1),6) = plus(plus(plus(6,7),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n1,n1))),n1),b(n0,b(n1,n1))) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,n1))).