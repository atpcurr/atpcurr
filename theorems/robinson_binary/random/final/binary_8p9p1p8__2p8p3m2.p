%theorem: plus(plus(plus(8,9),1),8) = mul(plus(plus(2,8),3),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,n1))).