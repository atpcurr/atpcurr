%theorem: mul(mul(plus(3,2),3),9) = mul(mul(mul(5,1),3),9)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(mul(b(n1,b(n0,n1)),n1),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).