%theorem: plus(plus(mul(4,1),4),1) = plus(plus(mul(1,1),6),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),n1) = plus(plus(mul(n1,n1),b(n0,b(n1,n1))),b(n0,n1))).