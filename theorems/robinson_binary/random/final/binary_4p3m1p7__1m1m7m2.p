%theorem: plus(mul(plus(4,3),1),7) = mul(mul(mul(1,1),7),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n1,n1)),n1),b(n1,b(n1,n1))) = mul(mul(mul(n1,n1),b(n1,b(n1,n1))),b(n0,n1))).