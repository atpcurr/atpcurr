%theorem: plus(mul(mul(3,2),3),8) = plus(plus(plus(3,8),6),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = plus(plus(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).