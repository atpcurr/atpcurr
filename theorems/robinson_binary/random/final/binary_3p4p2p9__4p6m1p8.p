%theorem: plus(plus(plus(3,4),2),9) = plus(mul(plus(4,6),1),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).