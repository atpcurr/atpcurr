%theorem: mul(plus(mul(3,6),4),1) = plus(mul(mul(2,7),1),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),n1) = plus(mul(mul(b(n0,n1),b(n1,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).