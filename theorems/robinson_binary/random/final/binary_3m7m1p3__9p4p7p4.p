%theorem: plus(mul(mul(3,7),1),3) = plus(plus(plus(9,4),7),4)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n1,n1))),n1),b(n1,n1)) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).