%theorem: plus(mul(mul(2,2),5),3) = plus(plus(plus(1,7),8),7)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)) = plus(plus(plus(n1,b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).