%theorem: mul(mul(plus(5,1),5),2) = plus(plus(mul(8,6),4),8)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).