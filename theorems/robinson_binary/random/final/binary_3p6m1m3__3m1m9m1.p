%theorem: mul(mul(plus(3,6),1),3) = mul(mul(mul(3,1),9),1)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n0,b(n1,n1))),n1),b(n1,n1)) = mul(mul(mul(b(n1,n1),n1),b(n1,b(n0,b(n0,n1)))),n1)).