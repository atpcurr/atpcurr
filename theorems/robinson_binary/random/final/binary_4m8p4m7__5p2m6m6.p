%theorem: mul(plus(mul(4,8),4),7) = mul(mul(plus(5,2),6),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = mul(mul(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).