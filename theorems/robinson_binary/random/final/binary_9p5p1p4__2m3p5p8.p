%theorem: plus(plus(plus(9,5),1),4) = plus(plus(mul(2,3),5),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n0,n1))) = plus(plus(mul(b(n0,n1),b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).