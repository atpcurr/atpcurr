%theorem: mul(plus(plus(6,7),1),6) = mul(plus(plus(8,5),1),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n0,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n1,n1)))).