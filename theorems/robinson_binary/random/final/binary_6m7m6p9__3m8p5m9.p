%theorem: plus(mul(mul(6,7),6),9) = mul(plus(mul(3,8),5),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).