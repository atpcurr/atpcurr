%theorem: plus(mul(plus(3,5),9),8) = mul(plus(mul(4,3),8),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).