%theorem: mul(mul(mul(5,6),1),8) = mul(plus(mul(3,9),3),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).