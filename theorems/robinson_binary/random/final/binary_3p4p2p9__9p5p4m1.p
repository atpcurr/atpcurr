%theorem: plus(plus(plus(3,4),2),9) = mul(plus(plus(9,5),4),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),n1)).