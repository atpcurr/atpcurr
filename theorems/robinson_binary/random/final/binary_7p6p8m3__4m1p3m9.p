%theorem: mul(plus(plus(7,6),8),3) = mul(plus(mul(4,1),3),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,n1)) = mul(plus(mul(b(n0,b(n0,n1)),n1),b(n1,n1)),b(n1,b(n0,b(n0,n1))))).