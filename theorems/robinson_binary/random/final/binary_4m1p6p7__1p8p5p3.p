%theorem: plus(plus(mul(4,1),6),7) = plus(plus(plus(1,8),5),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(plus(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1))).