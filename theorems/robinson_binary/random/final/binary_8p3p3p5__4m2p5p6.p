%theorem: plus(plus(plus(8,3),3),5) = plus(plus(mul(4,2),5),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))) = plus(plus(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n1,n1)))).