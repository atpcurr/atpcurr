%theorem: plus(plus(plus(2,7),7),7) = plus(plus(mul(7,2),5),4)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = plus(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,n1)))).