%theorem: plus(plus(plus(8,4),4),3) = plus(plus(plus(6,7),1),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n1,n1))),n1),b(n1,b(n0,n1)))).