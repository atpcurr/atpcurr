%theorem: plus(plus(plus(7,8),4),8) = plus(plus(plus(9,3),6),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).