%theorem: mul(plus(mul(8,2),3),4) = plus(plus(mul(7,9),5),8)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))) = plus(plus(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).