%theorem: plus(plus(plus(9,1),3),6) = plus(plus(mul(3,5),1),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n1,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n1,n1),b(n1,b(n0,n1))),n1),b(n1,n1))).