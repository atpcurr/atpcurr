%theorem: mul(plus(plus(9,3),8),5) = mul(mul(plus(4,6),5),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,n1))).