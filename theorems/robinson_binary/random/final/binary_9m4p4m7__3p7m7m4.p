%theorem: mul(plus(mul(9,4),4),7) = mul(mul(plus(3,7),7),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = mul(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).