%theorem: mul(mul(plus(6,9),5),6) = mul(mul(mul(3,5),6),5)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = mul(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).