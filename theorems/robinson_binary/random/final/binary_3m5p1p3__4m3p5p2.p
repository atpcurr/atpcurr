%theorem: plus(plus(mul(3,5),1),3) = plus(plus(mul(4,3),5),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n1,b(n0,n1))),n1),b(n1,n1)) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1))).