%theorem: mul(plus(plus(5,1),2),6) = plus(plus(mul(6,6),8),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).