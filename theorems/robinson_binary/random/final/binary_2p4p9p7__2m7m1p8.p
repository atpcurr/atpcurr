%theorem: plus(plus(plus(2,4),9),7) = plus(mul(mul(2,7),1),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = plus(mul(mul(b(n0,n1),b(n1,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).