%theorem: plus(plus(mul(7,1),1),7) = plus(plus(mul(2,2),3),8)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),n1),n1),b(n1,b(n1,n1))) = plus(plus(mul(b(n0,n1),b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1))))).