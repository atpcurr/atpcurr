%theorem: plus(plus(mul(2,7),6),7) = plus(plus(plus(9,1),8),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).