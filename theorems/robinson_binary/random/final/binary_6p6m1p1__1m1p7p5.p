%theorem: plus(mul(plus(6,6),1),1) = plus(plus(mul(1,1),7),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),n1) = plus(plus(mul(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,n1)))).