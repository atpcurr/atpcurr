%theorem: mul(plus(plus(4,3),9),3) = plus(mul(plus(1,5),7),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = plus(mul(plus(n1,b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1)))).