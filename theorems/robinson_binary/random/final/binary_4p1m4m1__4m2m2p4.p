%theorem: mul(mul(plus(4,1),4),1) = plus(mul(mul(4,2),2),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),n1) = plus(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1)))).