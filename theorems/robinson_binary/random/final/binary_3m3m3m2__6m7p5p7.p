%theorem: mul(mul(mul(3,3),3),2) = plus(plus(mul(6,7),5),7)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n0,n1)) = plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1)))).