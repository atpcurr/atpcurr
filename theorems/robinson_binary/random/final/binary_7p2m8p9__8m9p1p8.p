%theorem: plus(mul(plus(7,2),8),9) = plus(plus(mul(8,9),1),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1))))).