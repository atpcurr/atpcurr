%theorem: plus(plus(mul(3,8),1),4) = plus(plus(plus(7,9),6),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,n1))) = plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n1,n1)))).