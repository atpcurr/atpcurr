%theorem: mul(mul(mul(4,2),3),2) = plus(plus(mul(4,9),9),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,n1)),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).