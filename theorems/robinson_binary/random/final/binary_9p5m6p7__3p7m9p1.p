%theorem: plus(mul(plus(9,5),6),7) = plus(mul(plus(3,7),9),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),n1)).