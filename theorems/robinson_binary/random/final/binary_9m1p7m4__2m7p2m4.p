%theorem: mul(plus(mul(9,1),7),4) = mul(plus(mul(2,7),2),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = mul(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1)))).