%theorem: plus(mul(plus(6,2),7),6) = plus(mul(plus(1,5),9),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = plus(mul(plus(n1,b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).