%theorem: plus(mul(plus(9,4),3),3) = mul(mul(mul(1,7),6),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n1,n1)) = mul(mul(mul(n1,b(n1,b(n1,n1))),b(n0,b(n1,n1))),n1)).