%theorem: plus(plus(plus(5,2),7),4) = plus(plus(mul(1,4),9),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(plus(mul(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).