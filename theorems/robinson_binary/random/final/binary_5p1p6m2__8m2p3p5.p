%theorem: mul(plus(plus(5,1),6),2) = plus(plus(mul(8,2),3),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1)))).