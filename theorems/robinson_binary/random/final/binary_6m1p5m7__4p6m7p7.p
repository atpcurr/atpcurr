%theorem: mul(plus(mul(6,1),5),7) = plus(mul(plus(4,6),7),7)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),n1),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n1,n1)))).