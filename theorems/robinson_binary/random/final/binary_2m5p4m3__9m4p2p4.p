%theorem: mul(plus(mul(2,5),4),3) = plus(plus(mul(9,4),2),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1)))).