%theorem: plus(plus(mul(4,3),5),2) = plus(plus(plus(6,9),1),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),n1),b(n1,n1))).