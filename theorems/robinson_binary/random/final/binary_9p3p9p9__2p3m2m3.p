%theorem: plus(plus(plus(9,3),9),9) = mul(mul(plus(2,3),2),3)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,n1),b(n1,n1)),b(n0,n1)),b(n1,n1))).