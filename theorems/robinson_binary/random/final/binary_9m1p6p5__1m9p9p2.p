%theorem: plus(plus(mul(9,1),6),5) = plus(plus(mul(1,9),9),2)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n1,n1))),b(n1,b(n0,n1))) = plus(plus(mul(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,n1))).