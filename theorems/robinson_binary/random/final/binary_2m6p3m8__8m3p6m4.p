%theorem: mul(plus(mul(2,6),3),8) = mul(plus(mul(8,3),6),4)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1)))).