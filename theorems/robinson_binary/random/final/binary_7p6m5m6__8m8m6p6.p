%theorem: mul(mul(plus(7,6),5),6) = plus(mul(mul(8,8),6),6)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))) = plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n1,n1)))).