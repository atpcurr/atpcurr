%theorem: mul(mul(plus(9,5),5),4) = mul(mul(plus(3,7),7),4)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = mul(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).