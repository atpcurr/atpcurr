%theorem: plus(mul(mul(2,2),5),3) = plus(plus(mul(2,8),5),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)) = plus(plus(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,n1))).