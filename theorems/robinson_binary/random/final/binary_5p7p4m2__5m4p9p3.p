%theorem: mul(plus(plus(5,7),4),2) = plus(plus(mul(5,4),9),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,n1)) = plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1))).