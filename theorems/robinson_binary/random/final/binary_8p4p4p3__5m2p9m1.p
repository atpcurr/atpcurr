%theorem: plus(plus(plus(8,4),4),3) = mul(plus(mul(5,2),9),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)) = mul(plus(mul(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1)).