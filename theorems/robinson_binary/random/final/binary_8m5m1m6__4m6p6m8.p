%theorem: mul(mul(mul(8,5),1),6) = mul(plus(mul(4,6),6),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n1,n1))) = mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1))))).