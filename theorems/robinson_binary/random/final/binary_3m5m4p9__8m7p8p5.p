%theorem: plus(mul(mul(3,5),4),9) = plus(plus(mul(8,7),8),5)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).