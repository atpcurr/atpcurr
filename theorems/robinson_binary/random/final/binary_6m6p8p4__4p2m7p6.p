%theorem: plus(plus(mul(6,6),8),4) = plus(mul(plus(4,2),7),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1)))).