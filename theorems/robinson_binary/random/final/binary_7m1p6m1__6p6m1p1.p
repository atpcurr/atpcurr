%theorem: mul(plus(mul(7,1),6),1) = plus(mul(plus(6,6),1),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),n1),b(n0,b(n1,n1))),n1) = plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),n1)).