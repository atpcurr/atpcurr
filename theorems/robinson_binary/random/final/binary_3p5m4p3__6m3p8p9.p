%theorem: plus(mul(plus(3,5),4),3) = plus(plus(mul(6,3),8),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)) = plus(plus(mul(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).