%theorem: plus(plus(plus(7,9),9),7) = mul(plus(mul(3,5),1),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = mul(plus(mul(b(n1,n1),b(n1,b(n0,n1))),n1),b(n0,n1))).