%theorem: mul(plus(plus(4,6),2),4) = mul(mul(plus(3,1),6),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1))) = mul(mul(plus(b(n1,n1),n1),b(n0,b(n1,n1))),b(n0,n1))).