%theorem: plus(plus(mul(6,9),5),1) = mul(plus(plus(7,2),3),5)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),n1) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1)))).