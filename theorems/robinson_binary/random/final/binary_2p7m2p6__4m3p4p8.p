%theorem: plus(mul(plus(2,7),2),6) = plus(plus(mul(4,3),4),8)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n1,n1))) = plus(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1))))).