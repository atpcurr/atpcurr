%theorem: mul(plus(plus(4,1),5),8) = mul(plus(mul(4,3),8),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),n1),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1)))).