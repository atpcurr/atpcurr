%theorem: plus(plus(mul(2,7),6),7) = plus(mul(mul(3,1),7),6)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(mul(mul(b(n1,n1),n1),b(n1,b(n1,n1))),b(n0,b(n1,n1)))).