%theorem: plus(plus(mul(9,2),5),2) = plus(plus(plus(5,2),9),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),b(n0,n1)) = plus(plus(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).