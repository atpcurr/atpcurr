%theorem: mul(mul(mul(4,9),8),4) = mul(mul(plus(7,9),9),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).