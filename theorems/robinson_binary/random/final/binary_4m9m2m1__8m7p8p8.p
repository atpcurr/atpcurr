%theorem: mul(mul(mul(4,9),2),1) = plus(plus(mul(8,7),8),8)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),n1) = plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1))))).