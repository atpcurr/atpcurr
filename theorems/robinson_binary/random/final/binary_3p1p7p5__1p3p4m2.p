%theorem: plus(plus(plus(3,1),7),5) = mul(plus(plus(1,3),4),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),n1),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = mul(plus(plus(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1))).