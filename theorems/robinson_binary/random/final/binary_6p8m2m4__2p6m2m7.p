%theorem: mul(mul(plus(6,8),2),4) = mul(mul(plus(2,6),2),7)
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,n1))) = mul(mul(plus(b(n0,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n1,n1)))).