%theorem: plus(plus(plus(7,1),9),1) = plus(mul(plus(1,2),4),6)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),n1) = plus(mul(plus(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).