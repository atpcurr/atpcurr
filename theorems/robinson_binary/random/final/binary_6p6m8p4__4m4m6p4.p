%theorem: plus(mul(plus(6,6),8),4) = plus(mul(mul(4,4),6),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = plus(mul(mul(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1)))).