%theorem: plus(mul(mul(2,5),4),9) = plus(mul(plus(9,3),4),1)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,n1))),n1)).