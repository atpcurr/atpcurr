%theorem: plus(mul(plus(4,3),1),7) = mul(plus(plus(5,1),1),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n1,n1)),n1),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,n1)),n1),n1),b(n0,n1))).