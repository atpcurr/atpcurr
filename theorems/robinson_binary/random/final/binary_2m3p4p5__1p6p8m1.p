%theorem: plus(plus(mul(2,3),4),5) = mul(plus(plus(1,6),8),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = mul(plus(plus(n1,b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),n1)).