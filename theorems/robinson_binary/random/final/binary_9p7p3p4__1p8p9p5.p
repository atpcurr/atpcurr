%theorem: plus(plus(plus(9,7),3),4) = plus(plus(plus(1,8),9),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)),b(n0,b(n0,n1))) = plus(plus(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1)))).