%theorem: plus(plus(mul(6,1),6),9) = plus(plus(mul(3,4),6),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1))).