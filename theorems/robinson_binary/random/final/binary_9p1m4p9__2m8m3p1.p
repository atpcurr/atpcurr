%theorem: plus(mul(plus(9,1),4),9) = plus(mul(mul(2,8),3),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),n1)).