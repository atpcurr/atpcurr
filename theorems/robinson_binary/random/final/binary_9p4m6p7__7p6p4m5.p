%theorem: plus(mul(plus(9,4),6),7) = mul(plus(plus(7,6),4),5)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1)))).