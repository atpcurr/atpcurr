%theorem: plus(mul(plus(9,7),9),9) = plus(mul(plus(8,8),9),9)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).