%theorem: mul(plus(plus(9,5),4),1) = plus(mul(plus(4,6),1),8)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),n1) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),n1),b(n0,b(n0,b(n0,n1))))).