%theorem: plus(mul(plus(5,9),8),2) = mul(plus(mul(9,6),3),2)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1)),b(n0,n1))).