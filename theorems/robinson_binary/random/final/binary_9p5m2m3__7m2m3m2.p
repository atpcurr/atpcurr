%theorem: mul(mul(plus(9,5),2),3) = mul(mul(mul(7,2),3),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1)),b(n1,n1)) = mul(mul(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n1,n1)),b(n0,n1))).