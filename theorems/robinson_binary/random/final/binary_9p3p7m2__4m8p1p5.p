%theorem: mul(plus(plus(9,3),7),2) = plus(plus(mul(4,8),1),5)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1))),b(n0,n1)) = plus(plus(mul(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1)))).