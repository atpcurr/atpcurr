%theorem: plus(mul(plus(2,3),1),4) = plus(mul(mul(1,5),1),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n1,n1)),n1),b(n0,b(n0,n1))) = plus(mul(mul(n1,b(n1,b(n0,n1))),n1),b(n0,b(n0,n1)))).