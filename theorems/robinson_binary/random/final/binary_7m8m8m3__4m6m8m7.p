%theorem: mul(mul(mul(7,8),8),3) = mul(mul(mul(4,6),8),7)
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,n1)) = mul(mul(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).