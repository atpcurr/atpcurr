%theorem: plus(plus(plus(5,5),9),5) = plus(plus(mul(2,9),1),5)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = plus(plus(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n0,n1)))).