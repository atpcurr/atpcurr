%theorem: mul(plus(plus(4,9),7),3) = mul(plus(mul(1,6),4),6)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,n1)) = mul(plus(mul(n1,b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1)))).