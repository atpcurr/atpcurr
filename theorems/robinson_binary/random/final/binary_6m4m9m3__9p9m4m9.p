%theorem: mul(mul(mul(6,4),9),3) = mul(mul(plus(9,9),4),9)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1))))).