%theorem: mul(plus(plus(5,1),6),2) = mul(plus(plus(5,3),4),2)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),n1),b(n0,b(n1,n1))),b(n0,n1)) = mul(plus(plus(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1))).