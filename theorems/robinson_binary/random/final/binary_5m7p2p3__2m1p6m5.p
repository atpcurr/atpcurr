%theorem: plus(plus(mul(5,7),2),3) = mul(plus(mul(2,1),6),5)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,n1)),b(n1,n1)) = mul(plus(mul(b(n0,n1),n1),b(n0,b(n1,n1))),b(n1,b(n0,n1)))).