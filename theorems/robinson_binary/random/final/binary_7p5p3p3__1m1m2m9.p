%theorem: plus(plus(plus(7,5),3),3) = mul(mul(mul(1,1),2),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n1,n1)) = mul(mul(mul(n1,n1),b(n0,n1)),b(n1,b(n0,b(n0,n1))))).