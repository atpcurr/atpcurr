%theorem: plus(plus(plus(7,4),9),1) = plus(plus(plus(6,9),4),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1) = plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1))).