%theorem: mul(plus(mul(2,8),9),4) = mul(plus(mul(3,6),2),5)
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,n1)))).