%theorem: plus(plus(plus(4,9),1),1) = plus(plus(mul(4,1),4),7)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),n1),n1) = plus(plus(mul(b(n0,b(n0,n1)),n1),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).