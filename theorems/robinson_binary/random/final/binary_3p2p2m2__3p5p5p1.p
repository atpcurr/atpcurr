%theorem: mul(plus(plus(3,2),2),2) = plus(plus(plus(3,5),5),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,n1)),b(n0,n1)) = plus(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),n1)).