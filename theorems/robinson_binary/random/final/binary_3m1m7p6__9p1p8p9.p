%theorem: plus(mul(mul(3,1),7),6) = plus(plus(plus(9,1),8),9)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),n1),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = plus(plus(plus(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).