%theorem: mul(mul(plus(3,3),8),1) = mul(mul(mul(4,2),3),2)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),n1) = mul(mul(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n1,n1)),b(n0,n1))).