%theorem: plus(plus(mul(9,3),7),8) = mul(plus(mul(2,5),4),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = mul(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1))).