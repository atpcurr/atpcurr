%theorem: mul(plus(plus(3,6),8),1) = plus(plus(plus(1,1),6),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),n1) = plus(plus(plus(n1,n1),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1))))).