%theorem: mul(plus(plus(2,2),6),1) = mul(plus(plus(2,4),4),1)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,b(n1,n1))),n1) = mul(plus(plus(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1)).