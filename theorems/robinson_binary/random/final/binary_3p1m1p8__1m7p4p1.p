%theorem: plus(mul(plus(3,1),1),8) = plus(plus(mul(1,7),4),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),n1),n1),b(n0,b(n0,b(n0,n1)))) = plus(plus(mul(n1,b(n1,b(n1,n1))),b(n0,b(n0,n1))),n1)).