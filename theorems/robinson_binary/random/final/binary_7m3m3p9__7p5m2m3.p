%theorem: plus(mul(mul(7,3),3),9) = mul(mul(plus(7,5),2),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)),b(n1,n1))).