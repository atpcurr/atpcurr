%theorem: plus(plus(plus(7,5),1),6) = mul(plus(mul(5,3),4),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),n1),b(n0,b(n1,n1))) = mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n0,b(n0,n1))),n1)).