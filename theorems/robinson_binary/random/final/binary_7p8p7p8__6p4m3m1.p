%theorem: plus(plus(plus(7,8),7),8) = mul(mul(plus(6,4),3),1)
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n1,n1)),n1)).