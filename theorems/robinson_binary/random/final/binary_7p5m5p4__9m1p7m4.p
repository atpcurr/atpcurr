%theorem: plus(mul(plus(7,5),5),4) = mul(plus(mul(9,1),7),4)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = mul(plus(mul(b(n1,b(n0,b(n0,n1))),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1)))).