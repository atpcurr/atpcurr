%theorem: mul(plus(plus(6,8),2),4) = plus(plus(mul(9,6),3),7)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,n1))) = plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,n1)),b(n1,b(n1,n1)))).