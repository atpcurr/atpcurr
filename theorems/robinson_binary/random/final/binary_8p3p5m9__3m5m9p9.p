%theorem: mul(plus(plus(8,3),5),9) = plus(mul(mul(3,5),9),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = plus(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).