%theorem: plus(plus(mul(3,9),4),7) = plus(mul(plus(4,3),5),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1))).