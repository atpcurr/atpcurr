%theorem: mul(plus(plus(3,3),3),9) = mul(mul(plus(6,3),3),3)
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = mul(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n1,n1)),b(n1,n1))).