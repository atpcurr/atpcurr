%theorem: plus(mul(mul(6,2),1),5) = plus(plus(plus(1,8),6),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n0,n1)),n1),b(n1,b(n0,n1))) = plus(plus(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,n1))).