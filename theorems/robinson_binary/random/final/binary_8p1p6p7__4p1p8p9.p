%theorem: plus(plus(plus(8,1),6),7) = plus(plus(plus(4,1),8),9)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = plus(plus(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1))))).