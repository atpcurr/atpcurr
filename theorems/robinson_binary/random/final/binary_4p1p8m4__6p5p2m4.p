%theorem: mul(plus(plus(4,1),8),4) = mul(plus(plus(6,5),2),4)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = mul(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n0,n1)),b(n0,b(n0,n1)))).