%theorem: mul(mul(mul(4,4),9),1) = mul(mul(mul(8,2),3),3)
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n1) = mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,n1)),b(n1,n1))).