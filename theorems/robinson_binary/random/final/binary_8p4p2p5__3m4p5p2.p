%theorem: plus(plus(plus(8,4),2),5) = plus(plus(mul(3,4),5),2)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))) = plus(plus(mul(b(n1,n1),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1))).