%theorem: plus(mul(mul(5,3),1),2) = plus(plus(mul(2,6),2),3)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,n1)),b(n1,n1)),n1),b(n0,n1)) = plus(plus(mul(b(n0,n1),b(n0,b(n1,n1))),b(n0,n1)),b(n1,n1))).