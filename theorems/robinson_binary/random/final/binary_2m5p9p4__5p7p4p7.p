%theorem: plus(plus(mul(2,5),9),4) = plus(plus(plus(5,7),4),7)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = plus(plus(plus(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).