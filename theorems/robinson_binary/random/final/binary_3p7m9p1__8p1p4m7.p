%theorem: plus(mul(plus(3,7),9),1) = mul(plus(plus(8,1),4),7)
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),n1) = mul(plus(plus(b(n0,b(n0,b(n0,n1))),n1),b(n0,b(n0,n1))),b(n1,b(n1,n1)))).