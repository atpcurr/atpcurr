%theorem: mul(plus(mul(5,1),7),4) = plus(mul(plus(4,2),7),6)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),n1),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = plus(mul(plus(b(n0,b(n0,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n1,n1)))).