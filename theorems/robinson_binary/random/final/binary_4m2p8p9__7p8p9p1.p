%theorem: plus(plus(mul(4,2),8),9) = plus(plus(plus(7,8),9),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = plus(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),n1)).