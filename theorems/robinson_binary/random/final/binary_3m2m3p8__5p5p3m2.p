%theorem: plus(mul(mul(3,2),3),8) = mul(plus(plus(5,5),3),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n0,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n0,n1))).