%theorem: plus(plus(mul(3,9),1),7) = plus(mul(plus(3,5),4),3)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),n1),b(n1,b(n1,n1))) = plus(mul(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1))).