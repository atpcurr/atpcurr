%theorem: plus(plus(plus(2,3),3),6) = plus(mul(plus(1,5),1),8)
...
fof(myformula, conjecture, plus(plus(plus(b(n0,n1),b(n1,n1)),b(n1,n1)),b(n0,b(n1,n1))) = plus(mul(plus(n1,b(n1,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1))))).