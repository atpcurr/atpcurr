%theorem: plus(plus(mul(9,5),2),9) = plus(mul(plus(9,2),5),1)
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),n1)).