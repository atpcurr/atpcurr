%theorem: plus(plus(mul(6,9),4),1) = plus(plus(mul(6,8),2),9)
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),n1) = plus(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,b(n0,n1))))).