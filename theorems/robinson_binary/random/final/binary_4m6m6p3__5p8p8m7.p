%theorem: plus(mul(mul(4,6),6),3) = mul(plus(plus(5,8),8),7)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n1,n1)) = mul(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1)))).