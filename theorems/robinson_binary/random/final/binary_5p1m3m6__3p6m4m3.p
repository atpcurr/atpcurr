%theorem: mul(mul(plus(5,1),3),6) = mul(mul(plus(3,6),4),3)
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),n1),b(n1,n1)),b(n0,b(n1,n1))) = mul(mul(plus(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,n1))).