%theorem: mul(plus(plus(2,9),7),7) = mul(plus(plus(9,3),2),9)
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1))))).