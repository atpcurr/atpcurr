%theorem: plus(mul(plus(6,4),2),1) = plus(mul(plus(6,3),2),3)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n1,n1)),b(n0,b(n0,n1))),b(n0,n1)),n1) = plus(mul(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,n1)),b(n1,n1))).