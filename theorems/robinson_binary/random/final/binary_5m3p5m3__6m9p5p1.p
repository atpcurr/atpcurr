%theorem: mul(plus(mul(5,3),5),3) = plus(plus(mul(6,9),5),1)
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)) = plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),n1)).