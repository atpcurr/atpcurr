%theorem: plus(mul(mul(6,1),2),6) = plus(mul(plus(1,7),2),2)
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),n1),b(n0,n1)),b(n0,b(n1,n1))) = plus(mul(plus(n1,b(n1,b(n1,n1))),b(n0,n1)),b(n0,n1))).