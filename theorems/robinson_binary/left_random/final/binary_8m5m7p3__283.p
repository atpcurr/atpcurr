%theorem: plus(mul(mul(8,5),7),3) = 283
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)) = b(n1,b(n1,b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,n1))))))))).