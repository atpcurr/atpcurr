%theorem: mul(plus(plus(6,3),9),7) = 126
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n1,b(n1,n1))))))).