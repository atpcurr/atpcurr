%theorem: mul(mul(mul(9,2),6),9) = 972
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))))))).