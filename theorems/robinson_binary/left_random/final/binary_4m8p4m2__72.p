%theorem: mul(plus(mul(4,8),4),2) = 72
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))).