%theorem: mul(mul(plus(5,4),4),4) = 144
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))).