%theorem: mul(plus(mul(8,4),1),5) = 165
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),n1),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n0,b(n0,b(n1,b(n0,n1)))))))).