%theorem: plus(mul(mul(3,9),4),6) = 114
...
fof(myformula, conjecture, plus(mul(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n0,b(n0,b(n1,b(n1,n1))))))).