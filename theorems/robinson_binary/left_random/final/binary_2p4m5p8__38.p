%theorem: plus(mul(plus(2,4),5),8) = 38
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n1,b(n0,b(n0,n1)))))).