%theorem: mul(plus(plus(7,9),5),8) = 168
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n0,n1)))))))).