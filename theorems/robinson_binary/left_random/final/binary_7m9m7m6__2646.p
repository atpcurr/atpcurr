%theorem: mul(mul(mul(7,9),7),6) = 2646
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n1,b(n0,b(n1,b(n0,b(n0,b(n1,b(n0,n1)))))))))))).