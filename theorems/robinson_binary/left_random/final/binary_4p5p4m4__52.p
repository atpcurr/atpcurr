%theorem: mul(plus(plus(4,5),4),4) = 52
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n1,b(n0,b(n1,n1)))))).