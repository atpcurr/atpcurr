%theorem: mul(plus(mul(9,7),6),7) = 483
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = b(n1,b(n1,b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,n1))))))))).