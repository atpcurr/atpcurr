%theorem: plus(plus(plus(6,3),8),8) = 25
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n0,b(n1,n1))))).