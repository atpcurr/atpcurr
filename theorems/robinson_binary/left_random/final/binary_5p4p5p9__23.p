%theorem: plus(plus(plus(5,4),5),9) = 23
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n1,b(n0,n1))))).