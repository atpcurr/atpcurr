%theorem: plus(plus(mul(8,9),2),0) = 74
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),n0) = b(n0,b(n1,b(n0,b(n1,b(n0,b(n0,n1))))))).