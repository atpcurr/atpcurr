%theorem: mul(mul(plus(4,9),9),9) = 1053
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))))))).