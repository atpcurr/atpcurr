%theorem: plus(plus(mul(5,4),9),4) = 33
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n1,b(n0,b(n0,b(n0,b(n0,n1)))))).