%theorem: plus(mul(plus(8,8),6),0) = 96
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),n0) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))).