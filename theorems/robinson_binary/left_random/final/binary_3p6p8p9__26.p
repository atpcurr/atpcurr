%theorem: plus(plus(plus(3,6),8),9) = 26
...
fof(myformula, conjecture, plus(plus(plus(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n1,n1))))).