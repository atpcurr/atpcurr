%theorem: mul(plus(plus(2,2),4),8) = 64
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))).