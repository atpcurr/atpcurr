%theorem: mul(mul(plus(4,0),9),9) = 324
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),n0),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n1,b(n0,b(n0,b(n0,b(n1,b(n0,n1))))))))).