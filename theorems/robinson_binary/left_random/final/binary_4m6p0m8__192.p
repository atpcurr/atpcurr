%theorem: mul(plus(mul(4,6),0),8) = 192
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),n0),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))))).