%theorem: mul(plus(mul(6,9),2),5) = 280
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,n1))))))))).