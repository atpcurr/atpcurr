%theorem: plus(plus(plus(6,9),9),9) = 33
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n0,b(n0,b(n0,n1)))))).