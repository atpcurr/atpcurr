%theorem: plus(plus(mul(4,9),3),9) = 48
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))).