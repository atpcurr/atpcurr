%theorem: mul(mul(mul(1,6),4),9) = 216
...
fof(myformula, conjecture, mul(mul(mul(n1,b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1)))))))).