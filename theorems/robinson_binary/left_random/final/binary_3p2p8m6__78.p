%theorem: mul(plus(plus(3,2),8),6) = 78
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,n1))))))).