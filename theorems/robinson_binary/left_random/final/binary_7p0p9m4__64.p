%theorem: mul(plus(plus(7,0),9),4) = 64
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),n0),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))).