%theorem: plus(mul(plus(2,8),6),9) = 69
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n0,b(n0,b(n0,n1))))))).