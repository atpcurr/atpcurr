%theorem: mul(mul(mul(6,8),4),2) = 384
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))))).