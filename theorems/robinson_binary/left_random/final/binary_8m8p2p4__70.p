%theorem: plus(plus(mul(8,8),2),4) = 70
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n0,n1))) = b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,n1))))))).