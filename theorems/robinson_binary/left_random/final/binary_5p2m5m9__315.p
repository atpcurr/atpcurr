%theorem: mul(mul(plus(5,2),5),9) = 315
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,n1))))))))).