%theorem: mul(mul(plus(8,3),9),2) = 198
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,b(n1,n1)))))))).