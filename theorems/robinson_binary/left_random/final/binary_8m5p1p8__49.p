%theorem: plus(plus(mul(8,5),1),8) = 49
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n0,b(n0,b(n1,n1)))))).