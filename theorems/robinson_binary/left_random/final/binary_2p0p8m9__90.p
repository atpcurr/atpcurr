%theorem: mul(plus(plus(2,0),8),9) = 90
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),n0),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))).