%theorem: plus(mul(plus(9,2),8),8) = 96
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))).