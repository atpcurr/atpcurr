%theorem: mul(plus(mul(3,8),7),5) = 155
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = b(n1,b(n1,b(n0,b(n1,b(n1,b(n0,b(n0,n1)))))))).