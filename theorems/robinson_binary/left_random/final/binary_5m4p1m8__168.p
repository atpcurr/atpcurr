%theorem: mul(plus(mul(5,4),1),8) = 168
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),n1),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n0,n1)))))))).