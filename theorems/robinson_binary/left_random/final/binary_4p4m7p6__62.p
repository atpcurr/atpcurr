%theorem: plus(mul(plus(4,4),7),6) = 62
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n1,n1)))))).