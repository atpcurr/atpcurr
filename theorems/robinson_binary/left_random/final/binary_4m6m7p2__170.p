%theorem: plus(mul(mul(4,6),7),2) = 170
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n0,n1)) = b(n0,b(n1,b(n0,b(n1,b(n0,b(n1,b(n0,n1)))))))).