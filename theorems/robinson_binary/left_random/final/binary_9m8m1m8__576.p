%theorem: mul(mul(mul(9,8),1),8) = 576
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))))).