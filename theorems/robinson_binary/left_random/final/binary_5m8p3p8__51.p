%theorem: plus(plus(mul(5,8),3),8) = 51
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n0,b(n0,b(n1,n1)))))).