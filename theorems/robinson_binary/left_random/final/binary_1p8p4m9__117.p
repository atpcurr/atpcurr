%theorem: mul(plus(plus(1,8),4),9) = 117
...
fof(myformula, conjecture, mul(plus(plus(n1,b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n0,b(n1,b(n1,n1))))))).