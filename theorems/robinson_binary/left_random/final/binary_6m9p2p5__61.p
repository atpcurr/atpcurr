%theorem: plus(plus(mul(6,9),2),5) = 61
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n1,b(n1,n1)))))).