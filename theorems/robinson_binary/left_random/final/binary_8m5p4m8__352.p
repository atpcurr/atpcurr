%theorem: mul(plus(mul(8,5),4),8) = 352
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,n1))))))))).