%theorem: plus(plus(mul(7,3),5),9) = 35
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n1,n1)),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n0,b(n0,b(n0,n1)))))).