%theorem: plus(mul(plus(1,9),5),8) = 58
...
fof(myformula, conjecture, plus(mul(plus(n1,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n1,b(n1,n1)))))).