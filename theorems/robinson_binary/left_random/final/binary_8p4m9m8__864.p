%theorem: mul(mul(plus(8,4),9),8) = 864
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1)))))))))).