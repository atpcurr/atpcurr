%theorem: plus(plus(plus(4,4),6),9) = 23
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n1,b(n0,n1))))).