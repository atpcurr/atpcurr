%theorem: mul(mul(plus(2,5),4),9) = 252
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n1,b(n1,b(n1,b(n1,b(n1,n1)))))))).