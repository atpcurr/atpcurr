%theorem: mul(mul(plus(6,5),4),4) = 176
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,n1)))))))).