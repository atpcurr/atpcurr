%theorem: plus(mul(plus(3,8),8),2) = 90
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,n1)) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))).