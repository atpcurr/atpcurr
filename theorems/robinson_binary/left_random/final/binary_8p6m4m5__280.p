%theorem: mul(mul(plus(8,6),4),5) = 280
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,n1))))))))).