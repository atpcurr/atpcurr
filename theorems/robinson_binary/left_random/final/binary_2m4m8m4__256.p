%theorem: mul(mul(mul(2,4),8),4) = 256
...
fof(myformula, conjecture, mul(mul(mul(b(n0,n1),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))))).