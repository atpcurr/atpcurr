%theorem: mul(plus(plus(6,8),1),6) = 90
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),n1),b(n0,b(n1,n1))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))).