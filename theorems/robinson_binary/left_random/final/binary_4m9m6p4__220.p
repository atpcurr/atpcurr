%theorem: plus(mul(mul(4,9),6),4) = 220
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n1,b(n1,b(n1,b(n0,b(n1,n1)))))))).