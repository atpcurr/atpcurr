%theorem: plus(mul(plus(3,6),4),9) = 45
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n1,b(n0,n1)))))).