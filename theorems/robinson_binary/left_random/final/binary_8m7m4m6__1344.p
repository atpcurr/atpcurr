%theorem: mul(mul(mul(8,7),4),6) = 1344
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n0,n1))))))))))).