%theorem: mul(plus(mul(8,3),8),3) = 96
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))).