%theorem: mul(mul(plus(8,8),4),2) = 128
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,n1)) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1)))))))).