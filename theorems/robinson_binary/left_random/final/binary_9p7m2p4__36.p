%theorem: plus(mul(plus(9,7),2),4) = 36
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1))) = b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))).