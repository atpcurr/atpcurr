%theorem: mul(plus(mul(2,5),5),8) = 120
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,n1))))))).