%theorem: plus(plus(mul(7,9),6),8) = 77
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n1,b(n0,b(n0,n1))))))).