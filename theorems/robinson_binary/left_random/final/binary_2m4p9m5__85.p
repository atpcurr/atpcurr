%theorem: mul(plus(mul(2,4),9),5) = 85
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n0,b(n1,b(n0,n1))))))).