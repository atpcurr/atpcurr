%theorem: plus(mul(mul(2,9),6),9) = 117
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n0,b(n1,b(n1,n1))))))).