%theorem: mul(plus(mul(7,6),0),9) = 378
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n0,b(n1,n1))),n0),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n1,b(n1,b(n0,n1))))))))).