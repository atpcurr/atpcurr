%theorem: plus(plus(plus(9,6),9),5) = 29
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n1,n1))))).