%theorem: plus(plus(mul(9,5),2),5) = 52
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))) = b(n0,b(n0,b(n1,b(n0,b(n1,n1)))))).