%theorem: mul(mul(mul(6,5),3),7) = 630
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,n1))),b(n1,n1)),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,n1)))))))))).