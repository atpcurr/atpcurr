%theorem: plus(mul(mul(8,6),9),1) = 433
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),n1) = b(n1,b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1))))))))).