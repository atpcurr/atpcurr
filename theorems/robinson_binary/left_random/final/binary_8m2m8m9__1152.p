%theorem: mul(mul(mul(8,2),8),9) = 1152
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))))))).