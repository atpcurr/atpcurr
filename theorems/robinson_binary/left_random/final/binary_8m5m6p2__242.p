%theorem: plus(mul(mul(8,5),6),2) = 242
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)) = b(n0,b(n1,b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))))).