%theorem: mul(plus(plus(8,6),9),9) = 207
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n1,b(n1,b(n0,b(n0,b(n1,n1)))))))).