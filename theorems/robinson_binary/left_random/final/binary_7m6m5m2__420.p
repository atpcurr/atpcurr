%theorem: mul(mul(mul(7,6),5),2) = 420
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,n1)) = b(n0,b(n0,b(n1,b(n0,b(n0,b(n1,b(n0,b(n1,n1))))))))).