%theorem: plus(plus(plus(8,7),5),7) = 27
...
fof(myformula, conjecture, plus(plus(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = b(n1,b(n1,b(n0,b(n1,n1))))).