%theorem: mul(plus(mul(9,8),9),3) = 243
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,n1)) = b(n1,b(n1,b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))))).