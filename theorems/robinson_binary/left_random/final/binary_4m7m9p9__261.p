%theorem: plus(mul(mul(4,7),9),9) = 261
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))))).