%theorem: mul(mul(mul(8,4),8),4) = 1024
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))))))).