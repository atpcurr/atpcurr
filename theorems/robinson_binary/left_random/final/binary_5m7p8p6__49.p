%theorem: plus(plus(mul(5,7),8),6) = 49
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n1,b(n0,b(n0,b(n0,b(n1,n1)))))).