%theorem: plus(mul(mul(2,6),8),6) = 102
...
fof(myformula, conjecture, plus(mul(mul(b(n0,n1),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,n1))))))).