%theorem: mul(plus(plus(3,5),6),7) = 98
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n0,b(n0,b(n0,b(n1,n1))))))).