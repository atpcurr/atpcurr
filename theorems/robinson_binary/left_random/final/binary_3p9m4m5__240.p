%theorem: mul(mul(plus(3,9),4),5) = 240
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))))).