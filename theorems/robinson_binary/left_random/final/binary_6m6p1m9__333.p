%theorem: mul(plus(mul(6,6),1),9) = 333
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n1,n1))),n1),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,b(n0,n1))))))))).