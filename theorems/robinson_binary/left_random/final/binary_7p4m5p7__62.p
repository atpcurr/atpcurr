%theorem: plus(mul(plus(7,4),5),7) = 62
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n1,n1)))))).