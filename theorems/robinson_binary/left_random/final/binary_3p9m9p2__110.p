%theorem: plus(mul(plus(3,9),9),2) = 110
...
fof(myformula, conjecture, plus(mul(plus(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = b(n0,b(n1,b(n1,b(n1,b(n0,b(n1,n1))))))).