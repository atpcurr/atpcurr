%theorem: mul(mul(plus(9,9),9),6) = 972
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))))))).