%theorem: plus(mul(plus(8,5),4),8) = 60
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n1,b(n1,b(n1,n1)))))).