%theorem: mul(plus(mul(8,9),0),4) = 288
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),n0),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))))).