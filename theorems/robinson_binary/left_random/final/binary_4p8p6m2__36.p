%theorem: mul(plus(plus(4,8),6),2) = 36
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,n1)) = b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))).