%theorem: plus(mul(plus(4,4),5),5) = 45
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,n1)),b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n1,b(n0,n1)))))).