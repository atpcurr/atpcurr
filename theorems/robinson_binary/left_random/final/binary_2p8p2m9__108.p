%theorem: mul(plus(plus(2,8),2),9) = 108
...
fof(myformula, conjecture, mul(plus(plus(b(n0,n1),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1))))))).