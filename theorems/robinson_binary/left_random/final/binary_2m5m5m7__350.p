%theorem: mul(mul(mul(2,5),5),7) = 350
...
fof(myformula, conjecture, mul(mul(mul(b(n0,n1),b(n1,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n1,b(n0,b(n1,b(n0,n1))))))))).