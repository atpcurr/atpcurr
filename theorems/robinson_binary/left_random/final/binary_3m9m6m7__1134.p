%theorem: mul(mul(mul(3,9),6),7) = 1134
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n0,b(n1,b(n1,b(n0,b(n0,b(n0,n1))))))))))).