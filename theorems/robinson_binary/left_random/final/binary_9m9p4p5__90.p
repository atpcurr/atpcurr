%theorem: plus(plus(mul(9,9),4),5) = 90
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))).