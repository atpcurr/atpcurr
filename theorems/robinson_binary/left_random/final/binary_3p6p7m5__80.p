%theorem: mul(plus(plus(3,6),7),5) = 80
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,n1))))))).