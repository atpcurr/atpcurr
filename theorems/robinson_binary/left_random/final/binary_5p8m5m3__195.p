%theorem: mul(mul(plus(5,8),5),3) = 195
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,n1)) = b(n1,b(n1,b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))))).