%theorem: mul(mul(plus(2,1),9),8) = 216
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),n1),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1)))))))).