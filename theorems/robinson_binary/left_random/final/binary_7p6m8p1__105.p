%theorem: plus(mul(plus(7,6),8),1) = 105
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))),n1) = b(n1,b(n0,b(n0,b(n1,b(n0,b(n1,n1))))))).