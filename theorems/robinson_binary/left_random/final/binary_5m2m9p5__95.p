%theorem: plus(mul(mul(5,2),9),5) = 95
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,n1)),b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = b(n1,b(n1,b(n1,b(n1,b(n1,b(n0,n1))))))).