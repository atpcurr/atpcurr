%theorem: mul(mul(plus(9,7),4),6) = 384
...
fof(myformula, conjecture, mul(mul(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))))).