%theorem: mul(plus(plus(9,9),2),6) = 120
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n1,n1))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,n1))))))).