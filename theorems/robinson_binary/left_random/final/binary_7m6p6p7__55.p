%theorem: plus(plus(mul(7,6),6),7) = 55
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n1,b(n1,n1))) = b(n1,b(n1,b(n1,b(n0,b(n1,n1)))))).