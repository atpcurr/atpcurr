%theorem: mul(plus(plus(9,4),9),2) = 44
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,n1)) = b(n0,b(n0,b(n1,b(n1,b(n0,n1)))))).