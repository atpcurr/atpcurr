%theorem: mul(mul(plus(1,5),7),9) = 378
...
fof(myformula, conjecture, mul(mul(plus(n1,b(n1,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n1,b(n1,b(n0,n1))))))))).