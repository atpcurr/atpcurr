%theorem: mul(mul(mul(5,6),3),5) = 450
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),b(n0,b(n1,n1))),b(n1,n1)),b(n1,b(n0,n1))) = b(n0,b(n1,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1))))))))).