%theorem: mul(mul(mul(6,2),7),7) = 588
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n0,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))) = b(n0,b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))))).