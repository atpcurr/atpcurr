%theorem: plus(mul(plus(9,8),9),9) = 162
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n0,b(n0,b(n0,b(n1,b(n0,n1)))))))).