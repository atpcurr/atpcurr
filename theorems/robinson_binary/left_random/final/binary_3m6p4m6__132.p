%theorem: mul(plus(mul(3,6),4),6) = 132
...
fof(myformula, conjecture, mul(plus(mul(b(n1,n1),b(n0,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n1,b(n0,b(n0,b(n0,b(n0,n1)))))))).