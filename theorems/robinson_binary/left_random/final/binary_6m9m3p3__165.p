%theorem: plus(mul(mul(6,9),3),3) = 165
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n1,n1)) = b(n1,b(n0,b(n1,b(n0,b(n0,b(n1,b(n0,n1)))))))).