%theorem: mul(plus(plus(9,7),2),4) = 72
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,n1)),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))).