%theorem: mul(plus(mul(6,4),1),9) = 225
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n1,n1)),b(n0,b(n0,n1))),n1),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1)))))))).