%theorem: mul(plus(plus(3,7),5),7) = 105
...
fof(myformula, conjecture, mul(plus(plus(b(n1,n1),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n1,n1))) = b(n1,b(n0,b(n0,b(n1,b(n0,b(n1,n1))))))).