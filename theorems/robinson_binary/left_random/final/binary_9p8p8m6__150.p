%theorem: mul(plus(plus(9,8),8),6) = 150
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n1,b(n0,b(n0,n1)))))))).