%theorem: mul(mul(plus(3,8),2),6) = 132
...
fof(myformula, conjecture, mul(mul(plus(b(n1,n1),b(n0,b(n0,b(n0,n1)))),b(n0,n1)),b(n0,b(n1,n1))) = b(n0,b(n0,b(n1,b(n0,b(n0,b(n0,b(n0,n1)))))))).