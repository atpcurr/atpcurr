%theorem: mul(plus(plus(7,7),7),6) = 126
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n1,b(n1,n1))))))).