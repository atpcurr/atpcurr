%theorem: mul(plus(mul(1,8),8),4) = 64
...
fof(myformula, conjecture, mul(plus(mul(n1,b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))).