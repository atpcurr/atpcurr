%theorem: mul(plus(plus(6,1),9),7) = 112
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n1,n1)),n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1))))))).