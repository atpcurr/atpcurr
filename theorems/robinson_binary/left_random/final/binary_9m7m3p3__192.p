%theorem: plus(mul(mul(9,7),3),3) = 192
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,n1)),b(n1,n1)) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))))).