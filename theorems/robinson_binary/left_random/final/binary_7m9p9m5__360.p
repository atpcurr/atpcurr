%theorem: mul(plus(mul(7,9),9),5) = 360
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))))).