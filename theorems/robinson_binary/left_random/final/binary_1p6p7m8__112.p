%theorem: mul(plus(plus(1,6),7),8) = 112
...
fof(myformula, conjecture, mul(plus(plus(n1,b(n0,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1))))))).