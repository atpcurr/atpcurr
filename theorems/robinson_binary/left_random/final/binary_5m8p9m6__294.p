%theorem: mul(plus(mul(5,8),9),6) = 294
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))))).