%theorem: mul(mul(mul(4,9),8),9) = 2592
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,b(n0,b(n1,b(n0,n1)))))))))))).