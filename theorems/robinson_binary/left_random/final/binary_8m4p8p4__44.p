%theorem: plus(plus(mul(8,4),8),4) = 44
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n1,b(n1,b(n0,n1)))))).