%theorem: plus(plus(mul(8,5),6),4) = 50
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = b(n0,b(n1,b(n0,b(n0,b(n1,n1)))))).