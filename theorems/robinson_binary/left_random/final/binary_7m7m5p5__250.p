%theorem: plus(mul(mul(7,7),5),5) = 250
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = b(n0,b(n1,b(n0,b(n1,b(n1,b(n1,b(n1,n1)))))))).