%theorem: mul(mul(mul(8,4),3),8) = 768
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))))))).