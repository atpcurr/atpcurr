%theorem: plus(mul(mul(5,9),2),9) = 99
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n0,b(n0,b(n0,b(n1,n1))))))).