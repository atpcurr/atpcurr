%theorem: plus(mul(plus(7,0),9),9) = 72
...
fof(myformula, conjecture, plus(mul(plus(b(n1,b(n1,n1)),n0),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))).