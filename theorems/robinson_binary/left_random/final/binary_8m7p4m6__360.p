%theorem: mul(plus(mul(8,7),4),6) = 360
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))))).