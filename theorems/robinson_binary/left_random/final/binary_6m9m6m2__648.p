%theorem: mul(mul(mul(6,9),6),2) = 648
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,n1)) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,b(n0,b(n1,b(n0,n1)))))))))).