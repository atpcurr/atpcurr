%theorem: plus(mul(mul(9,7),5),4) = 319
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = b(n1,b(n1,b(n1,b(n1,b(n1,b(n1,b(n0,b(n0,n1))))))))).