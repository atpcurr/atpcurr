%theorem: plus(plus(plus(9,9),9),8) = 35
...
fof(myformula, conjecture, plus(plus(plus(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n1,b(n0,b(n0,b(n0,n1)))))).