%theorem: mul(plus(mul(2,9),3),8) = 168
...
fof(myformula, conjecture, mul(plus(mul(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n1,b(n0,n1)))))))).