%theorem: plus(plus(mul(8,9),5),9) = 86
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n1,b(n0,b(n1,b(n0,n1))))))).