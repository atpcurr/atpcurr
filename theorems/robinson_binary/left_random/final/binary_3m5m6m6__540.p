%theorem: mul(mul(mul(3,5),6),6) = 540
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n1,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,b(n0,b(n0,n1)))))))))).