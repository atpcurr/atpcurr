%theorem: plus(mul(mul(9,5),4),4) = 184
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,b(n0,n1)))))))).