%theorem: mul(mul(mul(3,4),4),4) = 192
...
fof(myformula, conjecture, mul(mul(mul(b(n1,n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1)))))))).