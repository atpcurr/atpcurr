%theorem: plus(mul(mul(8,8),4),5) = 261
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = b(n1,b(n0,b(n1,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))))).