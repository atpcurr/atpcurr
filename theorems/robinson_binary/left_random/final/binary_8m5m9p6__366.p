%theorem: plus(mul(mul(8,5),9),6) = 366
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n0,b(n0,n1))),b(n1,b(n0,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n1,b(n1,b(n1,b(n0,b(n1,b(n1,b(n0,n1))))))))).