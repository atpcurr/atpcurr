%theorem: mul(mul(mul(5,4),4),8) = 640
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,n1)),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,n1)))))))))).