%theorem: plus(plus(mul(9,6),6),4) = 64
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,b(n1,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,n1))))))).