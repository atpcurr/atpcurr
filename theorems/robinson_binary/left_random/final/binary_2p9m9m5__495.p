%theorem: mul(mul(plus(2,9),9),5) = 495
...
fof(myformula, conjecture, mul(mul(plus(b(n0,n1),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))) = b(n1,b(n1,b(n1,b(n1,b(n0,b(n1,b(n1,b(n1,n1))))))))).