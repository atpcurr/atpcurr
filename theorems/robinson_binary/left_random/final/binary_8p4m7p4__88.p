%theorem: plus(mul(plus(8,4),7),4) = 88
...
fof(myformula, conjecture, plus(mul(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,n1))))))).