%theorem: mul(plus(plus(8,6),2),9) = 144
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n1,n1))),b(n0,n1)),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))).