%theorem: mul(plus(plus(8,4),4),5) = 80
...
fof(myformula, conjecture, mul(plus(plus(b(n0,b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n0,b(n0,n1))),b(n1,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,n1))))))).