%theorem: mul(mul(mul(4,6),5),4) = 480
...
fof(myformula, conjecture, mul(mul(mul(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n1,n1))))))))).