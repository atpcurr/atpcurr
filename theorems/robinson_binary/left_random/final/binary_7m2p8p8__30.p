%theorem: plus(plus(mul(7,2),8),8) = 30
...
fof(myformula, conjecture, plus(plus(mul(b(n1,b(n1,n1)),b(n0,n1)),b(n0,b(n0,b(n0,n1)))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n1,b(n1,b(n1,n1))))).