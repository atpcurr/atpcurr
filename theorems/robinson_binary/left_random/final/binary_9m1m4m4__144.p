%theorem: mul(mul(mul(9,1),4),4) = 144
...
fof(myformula, conjecture, mul(mul(mul(b(n1,b(n0,b(n0,n1))),n1),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))).