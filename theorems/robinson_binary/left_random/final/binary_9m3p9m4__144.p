%theorem: mul(plus(mul(9,3),9),4) = 144
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n0,b(n0,n1))),b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))).