%theorem: mul(mul(plus(0,9),5),5) = 225
...
fof(myformula, conjecture, mul(mul(plus(n0,b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n1,b(n0,n1))) = b(n1,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1)))))))).