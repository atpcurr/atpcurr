%theorem: mul(plus(mul(8,3),0),9) = 216
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,b(n0,n1))),b(n1,n1)),n0),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1)))))))).