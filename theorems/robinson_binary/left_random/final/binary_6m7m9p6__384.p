%theorem: plus(mul(mul(6,7),9),6) = 384
...
fof(myformula, conjecture, plus(mul(mul(b(n0,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,n1))))))))).