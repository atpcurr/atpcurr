%theorem: mul(plus(plus(5,9),4),4) = 72
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1))))))).