%theorem: plus(plus(mul(4,7),4),7) = 39
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,n1)),b(n1,b(n1,n1))),b(n0,b(n0,n1))),b(n1,b(n1,n1))) = b(n1,b(n1,b(n1,b(n0,b(n0,n1)))))).