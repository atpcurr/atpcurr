%theorem: mul(mul(plus(4,6),9),7) = 630
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,n1)),b(n0,b(n1,n1))),b(n1,b(n0,b(n0,n1)))),b(n1,b(n1,n1))) = b(n0,b(n1,b(n1,b(n0,b(n1,b(n1,b(n1,b(n0,b(n0,n1)))))))))).