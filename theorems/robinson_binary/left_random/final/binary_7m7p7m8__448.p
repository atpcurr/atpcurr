%theorem: mul(plus(mul(7,7),7),8) = 448
...
fof(myformula, conjecture, mul(plus(mul(b(n1,b(n1,n1)),b(n1,b(n1,n1))),b(n1,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,n1))))))))).