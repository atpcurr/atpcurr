%theorem: mul(plus(mul(4,9),9),4) = 180
...
fof(myformula, conjecture, mul(plus(mul(b(n0,b(n0,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))),b(n0,b(n0,n1))) = b(n0,b(n0,b(n1,b(n0,b(n1,b(n1,b(n0,n1)))))))).