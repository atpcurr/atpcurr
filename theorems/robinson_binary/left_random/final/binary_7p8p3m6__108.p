%theorem: mul(plus(plus(7,8),3),6) = 108
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n0,b(n0,b(n0,n1)))),b(n1,n1)),b(n0,b(n1,n1))) = b(n0,b(n0,b(n1,b(n1,b(n0,b(n1,n1))))))).