%theorem: plus(mul(mul(7,9),5),2) = 317
...
fof(myformula, conjecture, plus(mul(mul(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n1,b(n0,n1))),b(n0,n1)) = b(n1,b(n0,b(n1,b(n1,b(n1,b(n1,b(n0,b(n0,n1))))))))).