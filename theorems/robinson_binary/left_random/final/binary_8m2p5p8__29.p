%theorem: plus(plus(mul(8,2),5),8) = 29
...
fof(myformula, conjecture, plus(plus(mul(b(n0,b(n0,b(n0,n1))),b(n0,n1)),b(n1,b(n0,n1))),b(n0,b(n0,b(n0,n1)))) = b(n1,b(n0,b(n1,b(n1,n1))))).