%theorem: mul(plus(plus(7,9),6),8) = 176
...
fof(myformula, conjecture, mul(plus(plus(b(n1,b(n1,n1)),b(n1,b(n0,b(n0,n1)))),b(n0,b(n1,n1))),b(n0,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n1,b(n1,b(n0,n1)))))))).