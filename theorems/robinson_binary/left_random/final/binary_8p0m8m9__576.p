%theorem: mul(mul(plus(8,0),8),9) = 576
...
fof(myformula, conjecture, mul(mul(plus(b(n0,b(n0,b(n0,n1))),n0),b(n0,b(n0,b(n0,n1)))),b(n1,b(n0,b(n0,n1)))) = b(n0,b(n0,b(n0,b(n0,b(n0,b(n0,b(n1,b(n0,b(n0,n1)))))))))).