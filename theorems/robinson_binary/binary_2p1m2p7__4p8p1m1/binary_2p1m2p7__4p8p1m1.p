%theorem: plus(mul(plus(2,1),2),7) = mul(plus(plus(4,8),1),1)
...
fof(myformula, conjecture, plus(mul(plus(b(n0,n1),n1),b(n0,n1)),b(n1,b(n1,n1))) = mul(plus(plus(b(n0,b(n0,n1)),b(n0,b(n0,b(n0,n1)))),n1),n1)).