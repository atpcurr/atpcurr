%theorem: mul(mul(mul(1,1),3),8) = mul(plus(plus(2,2),2),4)
...
fof(myformula, conjecture, mul(mul(mul(n1,n1),b(n1,n1)),b(n0,b(n0,b(n0,n1)))) = mul(plus(plus(b(n0,n1),b(n0,n1)),b(n0,n1)),b(n0,b(n0,n1)))).