...
base_config = Munch(actions_added=False,
                    ...
                    outdir="results/noproof_m2n140_eval",
                    parallel_envs=30,
                    proof_dir="noproof",
                    quick_progress_percentage=0.9,
                    saved_model="results/noproof_m2n140_2/ppo1_fcop_train_0",
...
def spec():
  return simple_handle_experiment(experiment_name = 'noproof_m2n140_eval',
