...
base_config = Munch(actions_added=False,
                    ...
                    evaldirs=["theorems/robinson_binary/simple/final/"],
                    evalcount=200000,
                    evaltime=60,
                    evaltype="mcts",
                    failure_reward=0,
                    ...
                    train_dirs=["theorems/robinson_binary/binary_3m3__9"],
...
def spec():
  return simple_handle_experiment(experiment_name = 'binary_simple',
