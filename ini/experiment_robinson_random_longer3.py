...
base_config = Munch(actions_added=False,
                    ...
                    outdir="results/robinson_random_longer3",
                    parallel_envs=1,
                    ...
                    train_timesteps=[6000000],
                    train_dirs=["theorems/robinson/longer3"],
...
def spec():
  return simple_handle_experiment(experiment_name = 'robinson_random_longer3',
