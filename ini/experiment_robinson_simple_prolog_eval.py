...
base_config = Munch(actions_added=False,
                    ...
                    evaldirs=["theorems/robinson/simple/small"],
                    evalcount=100,
                    evaltime=60,
                    evaltype="prob",
                    failure_reward=0,
                    ...
                    outdir="results/robinson_simple_prolog_eval",
                    parallel_envs=1,
                    proof_dir="theorems/proofs/prolog_proofs",
                    quick_progress_percentage=0.9,
                    saved_model="results/robinson_simple_prolog/ppo1_fcop_train_0",
...
def spec():
  return simple_handle_experiment(experiment_name = 'robinson_simple',
